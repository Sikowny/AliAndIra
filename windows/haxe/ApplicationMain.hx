...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ali and Ira", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Ali and Ira", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ali and Ira";
		app.meta["name"] = "Friday Night Funkin': Ali and Ira";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Ali and Ira",
			width: 1280,
			x: null,
			y: null,
		};
