...
HX_DEFINE_STACK_FRAME(_hx_pos_3fccbae956d84d25_720_new,"AccuracyDOption","new",0xe62cee92,"AccuracyDOption.new","Options.hx",720,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_726_press,"AccuracyDOption","press",0xad8ae235,"AccuracyDOption.press","Options.hx",726,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_734_updateDisplay,"AccuracyDOption","updateDisplay",0xd1d41feb,"AccuracyDOption.updateDisplay","Options.hx",734,0x9d9a0240)

void AccuracyDOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_720_new)
HXLINE( 721)		super::__construct();
HXLINE( 722)		this->description = desc;
            	}
...
bool AccuracyDOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_726_press)
HXLINE( 727)		 ::Dynamic _hx_tmp;
HXDLIN( 727)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),1 )) {
HXLINE( 727)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 727)			_hx_tmp = 1;
            		}
HXDLIN( 727)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyMod",09,b2,8a,86),_hx_tmp,::hx::paccDynamic);
HXLINE( 728)		this->display = this->updateDisplay();
HXLINE( 729)		return true;
            	}


::String AccuracyDOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_734_updateDisplay)
HXDLIN( 734)		::String _hx_tmp;
HXDLIN( 734)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),0 )) {
HXDLIN( 734)			_hx_tmp = HX_("Accurate",14,d1,76,d9);
            		}
            		else {
HXDLIN( 734)			_hx_tmp = HX_("Complex",10,8e,c2,50);
            		}
HXDLIN( 734)		return (HX_("Accuracy Mode: ",d0,5b,59,26) + _hx_tmp);
            	}
