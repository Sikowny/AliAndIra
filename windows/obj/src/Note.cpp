...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_263_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",263,0x1a8855ec)
...
HXLINE(  44)		this->noteScore = ((Float)1);
HXLINE(  40)		this->isAlt = false;
HXLINE(  38)		this->luaID = 0;
HXLINE(  36)		this->noteSection = 0;
...
HXLINE( 221)		Float stepHeight = (((Float)0.45) * ::Conductor_obj::stepCrochet);
HXDLIN( 221)		Float stepHeight1;
HXDLIN( 221)		if ((::PlayStateChangeables_obj::scrollSpeed == 1)) {
HXLINE( 221)			stepHeight1 = ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 221)			stepHeight1 = ::PlayStateChangeables_obj::scrollSpeed;
            		}
HXDLIN( 221)		Float stepHeight2 = (stepHeight * ::flixel::math::FlxMath_obj::roundDecimal(stepHeight1,2));
HXLINE( 225)		bool _hx_tmp3;
HXDLIN( 225)		if (this->isSustainNote) {
HXLINE( 225)			_hx_tmp3 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 225)			_hx_tmp3 = false;
            		}
HXDLIN( 225)		if (_hx_tmp3) {
HXLINE( 228)			this->set_alpha(((Float)0.6));
HXLINE( 230)			{
HXLINE( 230)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 230)				Float _g1 = _g->x;
HXDLIN( 230)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 232)			this->originColor = prevNote->originColor;
HXLINE( 233)			this->originAngle = prevNote->originAngle;
HXLINE( 235)			this->animation->play((this->dataColor->__get(this->originColor) + HX_("holdend",fc,4b,02,b8)),null(),null(),null());
HXLINE( 236)			this->updateHitbox();
HXLINE( 238)			{
HXLINE( 238)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 238)				Float _g3 = _g2->x;
HXDLIN( 238)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 242)			if (( (bool)(inCharter) )) {
HXLINE( 243)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 243)				_g->set_x((_g->x + 30));
            			}
HXLINE( 245)			if (prevNote->isSustainNote) {
HXLINE( 247)				prevNote->animation->play((this->dataColor->__get(prevNote->originColor) + HX_("hold",3f,c9,12,45)),null(),null(),null());
HXLINE( 248)				prevNote->updateHitbox();
HXLINE( 251)				{
HXLINE( 251)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 251)					Float _g1 = _g->y;
HXDLIN( 251)					_g->set_y((_g1 * ((stepHeight2 + 1) / prevNote->get_height())));
            				}
HXLINE( 252)				prevNote->updateHitbox();
HXLINE( 253)				prevNote->noteYOff = ::Math_obj::round(-(prevNote->offset->y));
HXLINE( 257)				this->noteYOff = ::Math_obj::round(-(this->offset->y));
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_263_update)
HXLINE( 264)		this->super::update(elapsed);
HXLINE( 265)		if (!(this->modifiedByLua)) {
HXLINE( 266)			this->set_angle((this->modAngle + this->localAngle));
            		}
            		else {
HXLINE( 268)			this->set_angle(this->modAngle);
            		}
HXLINE( 270)		if (!(this->modifiedByLua)) {
HXLINE( 272)			if (!(this->sustainActive)) {
HXLINE( 274)				this->set_alpha(((Float)0.3));
            			}
            		}
HXLINE( 278)		if (this->mustPress) {
HXLINE( 280)			if (this->isSustainNote) {
HXLINE( 282)				bool _hx_tmp;
HXDLIN( 282)				Float _hx_tmp1;
HXDLIN( 282)				if ((::PlayState_obj::songMultiplier < 1)) {
HXLINE( 282)					_hx_tmp1 = ::PlayState_obj::songMultiplier;
            				}
            				else {
HXLINE( 282)					_hx_tmp1 = ( (Float)(1) );
            				}
HXDLIN( 282)				if (((this->strumTime - ::Conductor_obj::songPosition) <= (((( (Float)(166) ) * ::Conductor_obj::timeScale) / _hx_tmp1) * ((Float)0.5)))) {
HXLINE( 283)					Float _hx_tmp1;
HXDLIN( 283)					if ((::PlayState_obj::songMultiplier < 1)) {
HXLINE( 283)						_hx_tmp1 = ::PlayState_obj::songMultiplier;
            					}
            					else {
HXLINE( 283)						_hx_tmp1 = ( (Float)(1) );
            					}
HXLINE( 282)					_hx_tmp = ((this->strumTime - ::Conductor_obj::songPosition) >= ((( (Float)(-166) ) * ::Conductor_obj::timeScale) / _hx_tmp1));
            				}
            				else {
HXLINE( 282)					_hx_tmp = false;
            				}
HXDLIN( 282)				if (_hx_tmp) {
HXLINE( 284)					this->canBeHit = true;
            				}
            				else {
HXLINE( 286)					this->canBeHit = false;
            				}
            			}
            			else {
HXLINE( 290)				bool _hx_tmp;
HXDLIN( 290)				Float _hx_tmp1;
HXDLIN( 290)				if ((::PlayState_obj::songMultiplier < 1)) {
HXLINE( 290)					_hx_tmp1 = ::PlayState_obj::songMultiplier;
            				}
            				else {
HXLINE( 290)					_hx_tmp1 = ( (Float)(1) );
            				}
HXDLIN( 290)				if (((this->strumTime - ::Conductor_obj::songPosition) <= ((( (Float)(166) ) * ::Conductor_obj::timeScale) / _hx_tmp1))) {
HXLINE( 291)					Float _hx_tmp1;
HXDLIN( 291)					if ((::PlayState_obj::songMultiplier < 1)) {
HXLINE( 291)						_hx_tmp1 = ::PlayState_obj::songMultiplier;
            					}
            					else {
HXLINE( 291)						_hx_tmp1 = ( (Float)(1) );
            					}
HXLINE( 290)					_hx_tmp = ((this->strumTime - ::Conductor_obj::songPosition) >= ((( (Float)(-166) ) * ::Conductor_obj::timeScale) / _hx_tmp1));
            				}
            				else {
...
HXDLIN( 307)		if (this->tooLate) {
HXLINE( 307)			_hx_tmp = !(this->wasGoodHit);
            		}
            		else {
...
void Note_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(noteSection,"noteSection");
...
void Note_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(noteSection,"noteSection");
...
::hx::Val Note_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"noteSection") ) { return ::hx::Val( noteSection ); }
...
::hx::Val Note_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"noteSection") ) { noteSection=inValue.Cast< int >(); return inValue; }
...
void Note_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("noteSection",13,d8,4f,11));
...
static ::hx::StorageInfo Note_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(Note_obj,noteSection),HX_("noteSection",13,d8,4f,11)},
