...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_96_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",96,0x01fbc1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_121_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",121,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_119_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",119,0x01fbc1e7)

void GameOverSubstate_obj::__construct(Float x,Float y){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_10_new)
HXLINE( 106)		this->isEnding = false;
HXLINE(  51)		this->startVibin = false;
HXLINE(  15)		this->stageSuffix = HX_("",00,00,00,00);
HXLINE(  19)		::String daStage = ::PlayState_obj::Stage->curStage;
HXLINE(  20)		::String daBf = HX_("",00,00,00,00);
HXLINE(  21)		if ((::PlayState_obj::boyfriend->curCharacter == HX_("bf-pixel",fd,03,90,37))) {
...
HXLINE(  62)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("InstantRespawn",e7,e4,09,0a),::hx::paccDynamic)) )) {
HXLINE(  64)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN(  64)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  64)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE(  67)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  69)			{
...
HXLINE(  72)				 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  72)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  72)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
            			else {
HXLINE(  74)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  74)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  74)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE(  75)			::PlayState_obj::loadRep = false;
            		}
HXLINE(  78)		bool _hx_tmp;
HXDLIN(  78)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  78)			_hx_tmp = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
...
HXLINE(  83)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  85)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
HXLINE(  86)			this->startVibin = true;
            		}
HXLINE(  89)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE(  91)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_96_beatHit)
HXLINE(  97)		this->super::beatHit();
HXLINE(  99)		bool _hx_tmp;
HXDLIN(  99)		if (this->startVibin) {
HXLINE(  99)			_hx_tmp = !(this->isEnding);
            		}
            		else {
HXLINE(  99)			_hx_tmp = false;
            		}
HXDLIN(  99)		if (_hx_tmp) {
HXLINE( 101)			this->bf->playAnim(HX_("deathLoop",b8,0b,79,2e),true,null(),null());
            		}
            	}
...
HXDLIN( 110)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_121_endBullshit)
HXLINE( 121)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 121)						::flixel::FlxG_obj::game->_requestedState = nextState;
            				...
            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_119_endBullshit)
HXLINE( 119)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 112)			::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 113)			this->isEnding = true;
HXLINE( 114)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 115)			{
HXLINE( 115)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXDLIN( 116)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 117)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
