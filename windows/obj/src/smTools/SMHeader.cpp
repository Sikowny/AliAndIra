...
HX_LOCAL_STACK_FRAME(_hx_pos_41987ab568a002b9_41_getBeatFromBPMIndex,"smTools.SMHeader","getBeatFromBPMIndex",0x00bc09cf,"smTools.SMHeader.getBeatFromBPMIndex","smTools/SMHeader.hx",41,0x44be2029)
...
Float SMHeader_obj::getBeatFromBPMIndex(int index){
            	HX_STACKFRAME(&_hx_pos_41987ab568a002b9_41_getBeatFromBPMIndex)
HXLINE(  42)		::Array< ::String > bpmSplit = this->BPMS.split(HX_(",",2c,00,00,00));
HXLINE(  43)		int beat = 0;
HXLINE(  44)		{
HXLINE(  44)			int _g = 0;
HXDLIN(  44)			int _g1 = bpmSplit->length;
HXDLIN(  44)			while((_g < _g1)){
HXLINE(  44)				_g = (_g + 1);
HXDLIN(  44)				int ii = (_g - 1);
HXLINE(  46)				if ((ii == index)) {
HXLINE(  47)					return ::Std_obj::parseFloat(::StringTools_obj::replace(bpmSplit->__get(ii).split(HX_("=",3d,00,00,00))->__get(0),HX_(",",2c,00,00,00),HX_("",00,00,00,00)));
            				}
            			}
            		}
HXLINE(  49)		return ((Float)0.0);
            	}


HX_DEFINE_DYNAMIC_FUNC1(SMHeader_obj,getBeatFromBPMIndex,return )
...
::hx::Val SMHeader_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"getBeatFromBPMIndex") ) { return ::hx::Val( getBeatFromBPMIndex_dyn() ); }
	}
...
static ::String SMHeader_obj_sMemberFields[] = {
	...
	HX_("getBeatFromBPMIndex",89,6a,ac,87),
