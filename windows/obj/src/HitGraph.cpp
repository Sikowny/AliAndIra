...
HX_LOCAL_STACK_FRAME(_hx_pos_dfe8d92fa5dee8a4_269_average,"HitGraph","average",0x47c52e0a,"HitGraph.average","HitGraph.hx",269,0x9e69dd83)
HX_LOCAL_STACK_FRAME(_hx_pos_dfe8d92fa5dee8a4_277_destroy,"HitGraph","destroy",0x096fe9a7,"HitGraph.destroy","HitGraph.hx",277,0x9e69dd83)
...
Float HitGraph_obj::average(){
            	HX_STACKFRAME(&_hx_pos_dfe8d92fa5dee8a4_269_average)
HXLINE( 270)		Float sum = ( (Float)(0) );
HXLINE( 271)		{
HXLINE( 271)			int _g = 0;
HXDLIN( 271)			::cpp::VirtualArray _g1 = this->history;
HXDLIN( 271)			while((_g < _g1->get_length())){
HXLINE( 271)				 ::Dynamic value = _g1->__get(_g);
HXDLIN( 271)				_g = (_g + 1);
HXLINE( 272)				sum = (sum + value);
            			}
            		}
HXLINE( 273)		return (sum / ( (Float)(this->history->get_length()) ));
            	}
...
void HitGraph_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dfe8d92fa5dee8a4_277_destroy)
HXLINE( 278)		this->_axis = ( ( ::openfl::display::Shape)(::flixel::util::FlxDestroyUtil_obj::removeChild(::hx::ObjectPtr<OBJ_>(this),this->_axis)) );
HXLINE( 279)		this->history = null();
            	}
