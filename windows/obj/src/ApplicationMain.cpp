...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Ali and Ira",4d,71,8a,e9),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("21",bf,2b,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("kadedev",9e,6b,37,01));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Ali and Ira",4d,71,8a,e9));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Ali and Ira",da,60,96,c2));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Ali and Ira",da,60,96,c2))
