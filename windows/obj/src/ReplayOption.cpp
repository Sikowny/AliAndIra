...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_699_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",699,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_705_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",705,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_713_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",713,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_699_new)
HXLINE( 700)		super::__construct();
HXLINE( 701)		this->description = desc;
            	}
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_705_press)
HXLINE( 707)		{
HXLINE( 707)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 707)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 707)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_713_updateDisplay)
HXDLIN( 713)		return HX_("Load replays",92,1b,40,79);
            	}
