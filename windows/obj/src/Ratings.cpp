...
static const int _hx_array_data_2ab48d96_6[] = {
	(int)166,(int)135,(int)90,(int)45,
};
...
::String Ratings_obj::judgeNote( ::Note note){
            	HX_STACKFRAME(&_hx_pos_c466427e4f3e0023_98_judgeNote)
HXLINE(  99)		Float diff;
HXDLIN(  99)		if ((::PlayState_obj::songMultiplier >= 1)) {
HXLINE(  99)			diff = ::PlayState_obj::songMultiplier;
            		}
            		else {
HXLINE(  99)			diff = ( (Float)(1) );
            		}
HXDLIN(  99)		Float diff1 = (::Math_obj::abs((note->strumTime - ::Conductor_obj::songPosition)) / diff);
HXLINE( 100)		{
HXLINE( 100)			int _g = 0;
...
HXDLIN( 104)				if ((diff1 < time)) {
HXLINE( 104)					_hx_tmp = (diff1 >= nextTime);
            				}
            				else {
...
HXLINE( 125)		::String _hx_tmp;
HXDLIN( 125)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )) {
HXLINE( 126)			::String _hx_tmp1;
HXDLIN( 126)			bool _hx_tmp2;
HXDLIN( 126)			if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 126)				_hx_tmp2 = ::PlayState_obj::loadRep;
            			}
            			else {
HXLINE( 126)				_hx_tmp2 = true;
            			}
HXDLIN( 126)			if (_hx_tmp2) {
HXLINE( 126)				_hx_tmp1 = HX_(" | ",44,b4,18,00);
            			}
            			else {
HXLINE( 126)				_hx_tmp1 = HX_("",00,00,00,00);
            			}
HXLINE( 125)			_hx_tmp = (((((HX_("NPS: ",b7,7e,61,1e) + nps) + HX_(" (Max ",24,31,a2,06)) + maxNPS) + HX_(")",29,00,00,00)) + _hx_tmp1);
            		}
            		else {
HXLINE( 125)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXLINE( 127)		::String _hx_tmp1;
HXDLIN( 127)		bool _hx_tmp2;
HXDLIN( 127)		if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 127)			_hx_tmp2 = ::PlayState_obj::loadRep;
            		}
            		else {
HXLINE( 127)			_hx_tmp2 = true;
            		}
HXDLIN( 127)		if (_hx_tmp2) {
HXLINE( 127)			::String _hx_tmp;
HXDLIN( 127)			if ((::Conductor_obj::safeFrames != 10)) {
HXLINE( 127)				_hx_tmp = (((score + HX_(" (",08,1c,00,00)) + scoreDef) + HX_(")",29,00,00,00));
            			}
            			else {
HXLINE( 127)				_hx_tmp = (HX_("",00,00,00,00) + score);
            			}
HXLINE( 128)			::String _hx_tmp2;
HXDLIN( 128)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )) {
HXLINE( 129)				::String _hx_tmp = ((HX_(" | Combo Breaks:",10,4a,42,f6) + ::PlayState_obj::misses) + HX_(" | Accuracy:",fd,ee,6b,1b));
HXLINE( 130)				::String _hx_tmp1;
HXDLIN( 130)				bool _hx_tmp3;
HXDLIN( 130)				if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 130)					_hx_tmp3 = !(::PlayState_obj::loadRep);
            				}
            				else {
HXLINE( 130)					_hx_tmp3 = false;
            				}
HXDLIN( 130)				if (_hx_tmp3) {
HXLINE( 130)					_hx_tmp1 = HX_("N/A",00,59,3b,00);
            				}
            				else {
HXLINE( 130)					_hx_tmp1 = (::HelperFunctions_obj::truncateFloat(accuracy,2) + HX_(" %",05,1c,00,00));
            				}
HXLINE( 128)				_hx_tmp2 = (((_hx_tmp + _hx_tmp1) + HX_(" | ",44,b4,18,00)) + ::Ratings_obj::GenerateLetterRank(accuracy));
            			}
            			else {
HXLINE( 128)				_hx_tmp2 = HX_("",00,00,00,00);
            			}
HXLINE( 127)			_hx_tmp1 = ((HX_("Score:",c8,e8,ff,79) + _hx_tmp) + _hx_tmp2);
            		}
            		else {
HXLINE( 127)			_hx_tmp1 = HX_("",00,00,00,00);
            		}
...
HXDLIN(  95)		timingWindows = ::Array_obj< int >::fromData( _hx_array_data_2ab48d96_6,4);
            	}
}
