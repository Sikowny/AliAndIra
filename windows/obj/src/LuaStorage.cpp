...
HX_LOCAL_STACK_FRAME(_hx_pos_8dd0ba9feb9a8366_28_boot,"LuaStorage","boot",0x2e539ffd,"LuaStorage.boot","LuaClass.hx",28,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_8dd0ba9feb9a8366_29_boot,"LuaStorage","boot",0x2e539ffd,"LuaStorage.boot","LuaClass.hx",29,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_8dd0ba9feb9a8366_30_boot,"LuaStorage","boot",0x2e539ffd,"LuaStorage.boot","LuaClass.hx",30,0xe0a4e33e)
...
{
{
            	HX_STACKFRAME(&_hx_pos_8dd0ba9feb9a8366_28_boot)
HXDLIN(  28)		ListOfCameras = ::Array_obj< ::Dynamic>::__new(0);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_8dd0ba9feb9a8366_29_boot)
HXDLIN(  29)		objectProperties =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_8dd0ba9feb9a8366_30_boot)
HXDLIN(  30)		objects =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
