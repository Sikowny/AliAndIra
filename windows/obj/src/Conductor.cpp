...
HX_DEFINE_STACK_FRAME(_hx_pos_9bd24c9adde08dff_36_new,"Conductor","new",0xc2a20839,"Conductor.new","Conductor.hx",36,0xeb0fa157)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_75_recalculateTimingStruct,"Conductor","recalculateTimingStruct",0xaba6fecb,"Conductor.recalculateTimingStruct","Conductor.hx",75,0xeb0fa157)
...
void Conductor_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_36_new)
            	}
...
void Conductor_obj::recalculateTimingStruct( ::Song SONG){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_75_recalculateTimingStruct)
HXDLIN(  75)		int _g = 0;
HXDLIN(  75)		::Array< ::Dynamic> _g1 = SONG->eventObjects;
HXDLIN(  75)		while((_g < _g1->length)){
HXDLIN(  75)			 ::Event i = _g1->__get(_g).StaticCast<  ::Event >();
HXDLIN(  75)			_g = (_g + 1);
            		}
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Conductor_obj,recalculateTimingStruct,(void))
...
bool Conductor_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 18:
		...
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"recalculateTimingStruct") ) { outValue = recalculateTimingStruct_dyn(); return true; }
	}
	return false;
}
...
static ::String Conductor_obj_sStaticFields[] = {
	...
	HX_("recalculateTimingStruct",72,64,09,c1),
