...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_213_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",213,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_218_press,"AccuracyOption","press",0x7bacf5c3,"AccuracyOption.press","Options.hx",218,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_226_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",226,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_213_new)
HXLINE( 214)		super::__construct();
HXLINE( 215)		this->description = desc;
            	}
...
bool AccuracyOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_218_press)
HXLINE( 219)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 220)		this->display = this->updateDisplay();
HXLINE( 221)		return true;
            	}


::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_226_updateDisplay)
HXDLIN( 226)		::String _hx_tmp;
HXDLIN( 226)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 226)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 226)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 226)		return (HX_("Accuracy ",a7,4b,73,6e) + _hx_tmp);
            	}
