...
HX_DEFINE_STACK_FRAME(_hx_pos_3ef98e6da45dca70_880_new,"ResetScoreOption","new",0x5d8eefea,"ResetScoreOption.new","Options.hx",880,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_890_press,"ResetScoreOption","press",0x4271e98d,"ResetScoreOption.press","Options.hx",890,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_915_updateDisplay,"ResetScoreOption","updateDisplay",0x42963f43,"ResetScoreOption.updateDisplay","Options.hx",915,0x9d9a0240)

void ResetScoreOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_880_new)
HXLINE( 882)		this->confirm = false;
HXLINE( 886)		super::__construct();
HXLINE( 887)		this->description = desc;
            	}
...
bool ResetScoreOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_890_press)
HXLINE( 891)		if (!(this->confirm)) {
HXLINE( 893)			this->confirm = true;
HXLINE( 894)			this->display = this->updateDisplay();
HXLINE( 895)			return true;
            		}
HXLINE( 897)		::flixel::FlxG_obj::save->data->__SetField(HX_("songScores",96,1a,f0,a0),null(),::hx::paccDynamic);
HXLINE( 898)		{
HXLINE( 898)			 ::Dynamic key = ::Highscore_obj::songScores->keys();
HXDLIN( 898)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 898)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 900)				::Highscore_obj::songScores->set(key1,0);
            			}
            		}
HXLINE( 902)		::flixel::FlxG_obj::save->data->__SetField(HX_("songCombos",1a,c2,aa,22),null(),::hx::paccDynamic);
HXLINE( 903)		{
HXLINE( 903)			 ::Dynamic key1 = ::Highscore_obj::songCombos->keys();
HXDLIN( 903)			while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 903)				::String key = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 905)				::Highscore_obj::songCombos->set(key,HX_("",00,00,00,00));
            			}
            		}
HXLINE( 907)		this->confirm = false;
HXLINE( 909)		this->display = this->updateDisplay();
HXLINE( 910)		return true;
            	}


::String ResetScoreOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_915_updateDisplay)
HXDLIN( 915)		if (this->confirm) {
HXDLIN( 915)			return HX_("Confirm Score Reset",01,e3,61,66);
            		}
            		else {
HXDLIN( 915)			return HX_("Reset Score",01,16,25,27);
            		}
