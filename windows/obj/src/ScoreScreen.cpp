...
HX_DEFINE_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_512_new,"ScoreScreen","new",0x96db9c30,"ScoreScreen.new","Options.hx",512,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_518_press,"ScoreScreen","press",0xe976b353,"ScoreScreen.press","Options.hx",518,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_526_updateDisplay,"ScoreScreen","updateDisplay",0x3fc33f09,"ScoreScreen.updateDisplay","Options.hx",526,0x9d9a0240)

void ScoreScreen_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_512_new)
HXLINE( 513)		super::__construct();
HXLINE( 514)		this->description = desc;
            	}
...
bool ScoreScreen_obj::press(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_518_press)
HXLINE( 519)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreScreen",5e,6c,c3,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 520)		this->display = this->updateDisplay();
HXLINE( 521)		return true;
            	}


::String ScoreScreen_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_526_updateDisplay)
HXDLIN( 526)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )) {
HXDLIN( 526)			return HX_("Show Score Screen",9d,cf,bf,e6);
            		}
            		else {
HXDLIN( 526)			return HX_("No Score Screen",d9,d1,47,3c);
            		}
