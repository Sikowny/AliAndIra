...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_233_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",233,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_238_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",238,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_246_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",246,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_233_new)
HXLINE( 234)		super::__construct();
HXLINE( 235)		this->description = desc;
            	}
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_238_press)
HXLINE( 239)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 240)		this->display = this->updateDisplay();
HXLINE( 241)		return true;
            	}


::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_246_updateDisplay)
HXDLIN( 246)		::String _hx_tmp;
HXDLIN( 246)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 246)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 246)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 246)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}
