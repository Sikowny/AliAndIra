...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_741_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",741,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_747_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",747,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_755_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",755,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_741_new)
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_747_press)
HXLINE( 749)		{
HXLINE( 749)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 749)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 749)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_755_updateDisplay)
HXDLIN( 755)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}
