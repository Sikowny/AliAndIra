...
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_280_chisel,"DiffCalc","chisel",0x5148a28a,"DiffCalc.chisel","DiffCalc.hx",280,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_298_calcuate,"DiffCalc","calcuate",0x92bbdd66,"DiffCalc.calcuate","DiffCalc.hx",298,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_313_findStupid,"DiffCalc","findStupid",0x6d0c39c4,"DiffCalc.findStupid","DiffCalc.hx",313,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_321_fingieCalc,"DiffCalc","fingieCalc",0xf18bd061,"DiffCalc.fingieCalc","DiffCalc.hx",321,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_343_smoothBrain,"DiffCalc","smoothBrain",0x0610b894,"DiffCalc.smoothBrain","DiffCalc.hx",343,0x0b7f13a4)
HX_LOCAL_STACK_FRAME(_hx_pos_ac88a8d52f7b54c5_361_smoothBrainTwo,"DiffCalc","smoothBrainTwo",0x25460158,"DiffCalc.smoothBrainTwo","DiffCalc.hx",361,0x0b7f13a4)
...
HXLINE(  58)		Float firstNoteTime = cleanedNotes->__get(0).StaticCast<  ::SmallNote >()->strumTime;
HXLINE(  62)		{
HXLINE(  62)			int _g2 = 0;
HXDLIN(  62)			while((_g2 < cleanedNotes->length)){
HXLINE(  62)				 ::SmallNote i = cleanedNotes->__get(_g2).StaticCast<  ::SmallNote >();
HXDLIN(  62)				_g2 = (_g2 + 1);
HXLINE(  64)				i->strumTime = ((i->strumTime - firstNoteTime) * ( (Float)(2) ));
            			}
            		}
HXLINE(  67)		{
HXLINE(  67)			int _g3 = 0;
HXDLIN(  67)			while((_g3 < cleanedNotes->length)){
HXLINE(  67)				 ::SmallNote i = cleanedNotes->__get(_g3).StaticCast<  ::SmallNote >();
HXDLIN(  67)				_g3 = (_g3 + 1);
HXLINE(  69)				switch((int)(i->noteData)){
            					case (int)0: {
HXLINE(  72)						handOne->push(i);
            					}
            					break;
            					case (int)1: {
HXLINE(  74)						handOne->push(i);
            					}
            					break;
            					case (int)2: {
HXLINE(  76)						handTwo->push(i);
            					}
            					break;
            					case (int)3: {
HXLINE(  78)						handTwo->push(i);
            					}
            					break;
            				}
            			}
            		}
HXLINE(  84)		::Array< Float > leftHandCol = ::Array_obj< Float >::__new(0);
HXLINE(  85)		::Array< Float > leftMHandCol = ::Array_obj< Float >::__new(0);
HXLINE(  86)		::Array< Float > rightMHandCol = ::Array_obj< Float >::__new(0);
HXLINE(  87)		::Array< Float > rightHandCol = ::Array_obj< Float >::__new(0);
HXLINE(  89)		{
HXLINE(  89)			int _g4 = 0;
HXDLIN(  89)			int _g5 = (handOne->length - 1);
HXDLIN(  89)			while((_g4 < _g5)){
HXLINE(  89)				_g4 = (_g4 + 1);
HXDLIN(  89)				int i = (_g4 - 1);
HXLINE(  91)				if ((handOne->__get(i).StaticCast<  ::SmallNote >()->noteData == 0)) {
HXLINE(  92)					leftHandCol->push(handOne->__get(i).StaticCast<  ::SmallNote >()->strumTime);
            				}
            				else {
HXLINE(  94)					leftMHandCol->push(handOne->__get(i).StaticCast<  ::SmallNote >()->strumTime);
            				}
            			}
            		}
HXLINE(  96)		{
HXLINE(  96)			int _g6 = 0;
HXDLIN(  96)			int _g7 = (handTwo->length - 1);
HXDLIN(  96)			while((_g6 < _g7)){
HXLINE(  96)				_g6 = (_g6 + 1);
HXDLIN(  96)				int i = (_g6 - 1);
HXLINE(  98)				if ((handTwo->__get(i).StaticCast<  ::SmallNote >()->noteData == 3)) {
HXLINE(  99)					rightHandCol->push(handTwo->__get(i).StaticCast<  ::SmallNote >()->strumTime);
            				}
            				else {
HXLINE( 101)					rightMHandCol->push(handTwo->__get(i).StaticCast<  ::SmallNote >()->strumTime);
            				}
            			}
            		}
...
HXLINE( 195)				Float bigFuck;
HXDLIN( 195)				if ((one > two)) {
HXLINE( 195)					bigFuck = one;
            				}
            				else {
HXLINE( 195)					bigFuck = two;
            				}
HXDLIN( 195)				Float bigFuck1 = ((((bigFuck * ( (Float)(8) )) + ((hand_npsOne->__get(i) / ::DiffCalc_obj::scale) * ( (Float)(5) ))) / ( (Float)(13) )) * ::DiffCalc_obj::scale);
HXLINE( 200)				hand_diffOne->push(bigFuck1);
            			}
            		}
HXLINE( 203)		{
HXLINE( 203)			int _g18 = 0;
HXDLIN( 203)			int _g19 = segmentsTwo->length;
HXDLIN( 203)			while((_g18 < _g19)){
HXLINE( 203)				_g18 = (_g18 + 1);
HXDLIN( 203)				int i = (_g18 - 1);
HXLINE( 205)				::Array< ::Dynamic> ve = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,i)) );
HXLINE( 206)				if (::hx::IsNull( ve )) {
HXLINE( 207)					continue;
            				}
HXLINE( 208)				::Array< ::Dynamic> fuckYouOne = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 209)				::Array< ::Dynamic> fuckYouTwo = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 210)				{
HXLINE( 210)					int _g = 0;
HXDLIN( 210)					while((_g < ve->length)){
HXLINE( 210)						 ::SmallNote note = ve->__get(_g).StaticCast<  ::SmallNote >();
HXDLIN( 210)						_g = (_g + 1);
HXLINE( 212)						switch((int)(note->noteData)){
            							case (int)2: {
HXLINE( 215)								fuckYouOne->push(note);
            							}
            							break;
            							case (int)3: {
HXLINE( 217)								fuckYouTwo->push(note);
            							}
            							break;
            						}
            					}
            				}
HXLINE( 221)				Float one = ::DiffCalc_obj::fingieCalc(fuckYouOne,rightMHandCol);
HXLINE( 222)				Float two = ::DiffCalc_obj::fingieCalc(fuckYouTwo,rightHandCol);
HXLINE( 224)				Float bigFuck;
HXDLIN( 224)				if ((one > two)) {
HXLINE( 224)					bigFuck = one;
            				}
            				else {
HXLINE( 224)					bigFuck = two;
            				}
HXDLIN( 224)				Float bigFuck1 = ((((bigFuck * ( (Float)(8) )) + ((hand_npsTwo->__get(i) / ::DiffCalc_obj::scale) * ( (Float)(5) ))) / ( (Float)(13) )) * ::DiffCalc_obj::scale);
HXLINE( 226)				hand_diffTwo->push(bigFuck1);
            			}
            		}
HXLINE( 231)		{
HXLINE( 232)			{
HXLINE( 233)				::DiffCalc_obj::smoothBrain(hand_npsOne,( (Float)(0) ));
HXLINE( 234)				::DiffCalc_obj::smoothBrain(hand_npsTwo,( (Float)(0) ));
HXLINE( 236)				::DiffCalc_obj::smoothBrainTwo(hand_diffOne);
HXLINE( 237)				::DiffCalc_obj::smoothBrainTwo(hand_diffTwo);
            			}
HXLINE( 232)			{
HXLINE( 233)				::DiffCalc_obj::smoothBrain(hand_npsOne,( (Float)(0) ));
HXLINE( 234)				::DiffCalc_obj::smoothBrain(hand_npsTwo,( (Float)(0) ));
...
HXLINE( 246)		::Array< Float > point_npsOne = ::Array_obj< Float >::__new();
HXLINE( 247)		::Array< Float > point_npsTwo = ::Array_obj< Float >::__new();
HXLINE( 249)		{
HXLINE( 249)			int _g20 = 0;
HXDLIN( 249)			while((_g20 < segmentsOne->length)){
HXLINE( 249)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsOne,_g20)) );
HXDLIN( 249)				_g20 = (_g20 + 1);
HXLINE( 251)				if (::hx::IsNull( i )) {
HXLINE( 252)					continue;
            				}
HXLINE( 253)				point_npsOne->push(i->length);
            			}
            		}
HXLINE( 255)		{
HXLINE( 255)			int _g21 = 0;
HXDLIN( 255)			while((_g21 < segmentsTwo->length)){
HXLINE( 255)				::Array< ::Dynamic> i = ( (::Array< ::Dynamic>)(_hx_array_unsafe_get(segmentsTwo,_g21)) );
HXDLIN( 255)				_g21 = (_g21 + 1);
HXLINE( 257)				if (::hx::IsNull( i )) {
HXLINE( 258)					continue;
            				}
HXLINE( 259)				point_npsTwo->push(i->length);
            			}
            		}
HXLINE( 262)		Float maxPoints = ( (Float)(0) );
HXLINE( 264)		{
HXLINE( 264)			int _g22 = 0;
HXDLIN( 264)			while((_g22 < point_npsOne->length)){
HXLINE( 264)				Float i = point_npsOne->__get(_g22);
HXDLIN( 264)				_g22 = (_g22 + 1);
HXLINE( 265)				maxPoints = (maxPoints + i);
            			}
            		}
HXLINE( 266)		{
HXLINE( 266)			int _g23 = 0;
HXDLIN( 266)			while((_g23 < point_npsTwo->length)){
HXLINE( 266)				Float i = point_npsTwo->__get(_g23);
HXDLIN( 266)				_g23 = (_g23 + 1);
HXLINE( 267)				maxPoints = (maxPoints + i);
            			}
            		}
HXLINE( 269)		if (::hx::IsGreater( accuracy,((Float).965) )) {
HXLINE( 270)			accuracy = ((Float).965);
            		}
HXLINE( 272)		::DiffCalc_obj::lastDiffHandOne = hand_diffOne;
HXLINE( 273)		::DiffCalc_obj::lastDiffHandTwo = hand_diffTwo;
HXLINE( 276)		return ::HelperFunctions_obj::truncateFloat(::DiffCalc_obj::chisel(( (Float)(accuracy) ),hand_diffOne,hand_diffTwo,point_npsOne,point_npsTwo,maxPoints),2);
            	}
...
Float DiffCalc_obj::chisel(Float scoreGoal,::Array< Float > diffOne,::Array< Float > diffTwo,::Array< Float > pointsOne,::Array< Float > pointsTwo,Float maxPoints){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_280_chisel)
HXLINE( 281)		Float lowerBound = ( (Float)(0) );
HXLINE( 282)		Float upperBound = ( (Float)(100) );
HXLINE( 284)		while(((upperBound - lowerBound) > ((Float)0.01))){
HXLINE( 286)			Float average = ((upperBound + lowerBound) / ( (Float)(2) ));
HXLINE( 287)			Float amtOfPoints = ::DiffCalc_obj::calcuate(average,diffOne,pointsOne);
HXDLIN( 287)			Float amtOfPoints1 = (amtOfPoints + ::DiffCalc_obj::calcuate(average,diffTwo,pointsTwo));
HXLINE( 288)			if (((amtOfPoints1 / maxPoints) < scoreGoal)) {
HXLINE( 289)				lowerBound = average;
            			}
            			else {
HXLINE( 291)				upperBound = average;
            			}
            		}
HXLINE( 294)		return upperBound;
            	}
...
Float DiffCalc_obj::calcuate(Float midPoint,::Array< Float > diff,::Array< Float > points){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_298_calcuate)
HXLINE( 299)		Float output = ( (Float)(0) );
HXLINE( 301)		{
HXLINE( 301)			int _g = 0;
HXDLIN( 301)			int _g1 = diff->length;
HXDLIN( 301)			while((_g < _g1)){
HXLINE( 301)				_g = (_g + 1);
HXDLIN( 301)				int i = (_g - 1);
HXLINE( 303)				Float res = diff->__get(i);
HXLINE( 304)				if ((midPoint > res)) {
HXLINE( 305)					output = (output + points->__get(i));
            				}
            				else {
HXLINE( 307)					output = (output + (points->__get(i) * ::Math_obj::pow((midPoint / res),((Float)1.2))));
            				}
            			}
            		}
HXLINE( 309)		return output;
            	}
...
int DiffCalc_obj::findStupid(Float strumTime,::Array< Float > array){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_313_findStupid)
HXLINE( 314)		{
HXLINE( 314)			int _g = 0;
HXDLIN( 314)			int _g1 = array->length;
HXDLIN( 314)			while((_g < _g1)){
HXLINE( 314)				_g = (_g + 1);
HXDLIN( 314)				int i = (_g - 1);
HXLINE( 315)				if ((array->__get(i) == strumTime)) {
HXLINE( 316)					return i;
            				}
            			}
            		}
...
Float DiffCalc_obj::fingieCalc(::Array< ::Dynamic> floats,::Array< Float > columArray){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_321_fingieCalc)
HXLINE( 322)		Float sum = ( (Float)(0) );
HXLINE( 323)		if ((floats->length == 0)) {
HXLINE( 324)			return ( (Float)(0) );
            		}
HXLINE( 325)		int startIndex = ::DiffCalc_obj::findStupid(floats->__get(0).StaticCast<  ::SmallNote >()->strumTime,columArray);
HXLINE( 326)		if ((startIndex == -1)) {
HXLINE( 327)			return ( (Float)(0) );
            		}
HXLINE( 328)		{
HXLINE( 328)			int _g = 0;
HXDLIN( 328)			while((_g < floats->length)){
HXLINE( 328)				 ::SmallNote i = floats->__get(_g).StaticCast<  ::SmallNote >();
HXDLIN( 328)				_g = (_g + 1);
HXLINE( 330)				sum = (sum + (columArray->__get((startIndex + 1)) - columArray->__get(startIndex)));
HXLINE( 331)				startIndex = (startIndex + 1);
            			}
            		}
HXLINE( 334)		if ((sum == 0)) {
HXLINE( 335)			return ( (Float)(0) );
            		}
HXLINE( 337)		return (( (Float)((1375 * floats->length)) ) / sum);
            	}
...
void DiffCalc_obj::smoothBrain(::Array< Float > npsVector,Float weirdchamp){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_343_smoothBrain)
HXLINE( 344)		Float floatOne = weirdchamp;
HXLINE( 345)		Float floatTwo = weirdchamp;
HXLINE( 347)		{
HXLINE( 347)			int _g = 0;
HXDLIN( 347)			int _g1 = npsVector->length;
HXDLIN( 347)			while((_g < _g1)){
HXLINE( 347)				_g = (_g + 1);
HXDLIN( 347)				int i = (_g - 1);
HXLINE( 349)				Float result = npsVector->__get(i);
HXLINE( 351)				Float chunker = floatOne;
HXLINE( 352)				floatOne = floatTwo;
HXLINE( 353)				floatTwo = result;
HXLINE( 355)				npsVector[i] = (((chunker + floatOne) + floatTwo) / ( (Float)(3) ));
            			}
            		}
            	}
...
void DiffCalc_obj::smoothBrainTwo(::Array< Float > diffVector){
            	HX_STACKFRAME(&_hx_pos_ac88a8d52f7b54c5_361_smoothBrainTwo)
HXLINE( 362)		Float floatZero = ( (Float)(0) );
HXLINE( 364)		{
HXLINE( 364)			int _g = 0;
HXDLIN( 364)			int _g1 = diffVector->length;
HXDLIN( 364)			while((_g < _g1)){
HXLINE( 364)				_g = (_g + 1);
HXDLIN( 364)				int i = (_g - 1);
HXLINE( 366)				Float result = diffVector->__get(i);
HXLINE( 368)				Float fuck = floatZero;
HXLINE( 369)				floatZero = result;
HXLINE( 370)				diffVector[i] = ((fuck + floatZero) / ( (Float)(2) ));
            			}
            		}
            	}
