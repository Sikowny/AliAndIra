...
HX_DEFINE_STACK_FRAME(_hx_pos_fc55aba1ba34c432_812_new,"BotPlay","new",0x2cacc9ed,"BotPlay.new","Options.hx",812,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_818_press,"BotPlay","press",0x783c8a50,"BotPlay.press","Options.hx",818,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_826_updateDisplay,"BotPlay","updateDisplay",0xe1e3db06,"BotPlay.updateDisplay","Options.hx",826,0x9d9a0240)

void BotPlay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_812_new)
HXLINE( 813)		super::__construct();
HXLINE( 814)		this->description = desc;
            	}
...
bool BotPlay_obj::press(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_818_press)
HXLINE( 819)		::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 821)		this->display = this->updateDisplay();
HXLINE( 822)		return true;
            	}


::String BotPlay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_826_updateDisplay)
HXDLIN( 826)		::String _hx_tmp;
HXDLIN( 826)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXDLIN( 826)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 826)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 826)		return (HX_("BotPlay ",45,3c,f1,7f) + _hx_tmp);
            	}
