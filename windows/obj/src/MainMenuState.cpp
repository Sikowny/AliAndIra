...
static const ::String _hx_array_data_205e8859_1[] = {
	HX_("story mode",6e,d7,a7,5e),HX_("freeplay",a0,90,86,22),HX_("credits",1a,0e,5e,13),HX_("options",5e,33,fe,df),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_198_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",198,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_204_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",204,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_239_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",239,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_272_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",272,0x0e5db805)
...
HXDLIN(  60)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("aliiramenu",99,e8,f4,14)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
...
HXLINE(  70)		bg1->screenCenter(null());
...
HXLINE(  77)		 ::flixel::FlxSprite _hx_tmp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  77)		::String library1 = null();
HXDLIN(  77)		this->magenta = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  78)		this->magenta->scrollFactor->set_x(( (Float)(0) ));
HXLINE(  79)		this->magenta->scrollFactor->set_y(((Float)0.10));
HXLINE(  80)		 ::flixel::FlxSprite _hx_tmp1 = this->magenta;
HXDLIN(  80)		_hx_tmp1->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.1))),null());
...
HXLINE( 105)				menuItem->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXLINE( 234)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_141_update)
HXLINE( 140)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 142)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 144)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 144)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXDLIN( 165)			if (_this->keyManager->checkStatus(38,_this->status)) {
...
HXDLIN( 171)			if (_this1->keyManager->checkStatus(40,_this1->status)) {
...
HXLINE( 184)				if ((this->optionShit->__get(this->curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 186)					this->fancyOpenURL(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_3, ::MainMenuState,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::FlxSprite spr){
            						HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_198_update)
HXLINE( 198)						if ((_gthis->curSelected != spr->ID)) {
            							HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxSprite,spr) HXARGC(1)
            							void _hx_run( ::flixel::tweens::FlxTween twn){
            								HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_204_update)
HXLINE( 204)								spr->kill();
            							}
            							HX_END_LOCAL_FUNC1((void))

HXLINE( 200)							::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 210)							if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
...
HXLINE( 214)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 212)								::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            							}
            							else {
...
HXLINE( 219)								 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 191)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 193)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 194)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 196)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_3(_gthis)),null());
            				}
            			}
            		}
HXLINE( 230)		this->super::update(elapsed);
HXLINE( 232)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_239_goToState)
HXLINE( 240)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 242)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("credits",1a,0e,5e,13)) ){
HXLINE( 256)			 ::flixel::FlxState nextState =  ::CreditsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 256)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 256)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 256)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 248)			 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 248)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 248)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 248)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 253)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 245)			 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::MainMenuState,_gthis) HXARGC(1)
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_272_changeItem)
...
HXLINE( 275)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
...
HXLINE( 260)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 262)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 264)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN(  43)		kadeEngineVer = (HX_("1.7",ba,56,25,00) + ::MainMenuState_obj::nightly);
            	}
{
