...
HX_DEFINE_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_849_new,"LockWeeksOption","new",0x229485fb,"LockWeeksOption.new","Options.hx",849,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_859_press,"LockWeeksOption","press",0x8495e5de,"LockWeeksOption.press","Options.hx",859,0x9d9a0240)
static const bool _hx_array_data_f0cd6c89_2[] = {
	1,1,
};
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_876_updateDisplay,"LockWeeksOption","updateDisplay",0x41787494,"LockWeeksOption.updateDisplay","Options.hx",876,0x9d9a0240)

void LockWeeksOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_849_new)
HXLINE( 851)		this->confirm = false;
HXLINE( 855)		super::__construct();
HXLINE( 856)		this->description = desc;
            	}
...
bool LockWeeksOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_859_press)
HXLINE( 860)		if (!(this->confirm)) {
HXLINE( 862)			this->confirm = true;
HXLINE( 863)			this->display = this->updateDisplay();
HXLINE( 864)			return true;
            		}
HXLINE( 866)		::flixel::FlxG_obj::save->data->__SetField(HX_("weekUnlocked",37,64,c4,a5),1,::hx::paccDynamic);
HXLINE( 867)		::StoryMenuState_obj::weekUnlocked = ::Array_obj< bool >::fromData( _hx_array_data_f0cd6c89_2,2);
HXLINE( 868)		this->confirm = false;
HXLINE( 870)		this->display = this->updateDisplay();
HXLINE( 871)		return true;
            	}


::String LockWeeksOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_876_updateDisplay)
HXDLIN( 876)		if (this->confirm) {
HXDLIN( 876)			return HX_("Confirm Story Reset",e4,1f,01,6b);
            		}
            		else {
HXDLIN( 876)			return HX_("Reset Story Progress",c9,28,76,d8);
            		}
HXDLIN( 876)		return null();
            	}
