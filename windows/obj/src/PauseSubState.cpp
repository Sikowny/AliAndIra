...
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_276_changeSelection,"PauseSubState","changeSelection",0x8f960fb5,"PauseSubState.changeSelection","PauseSubState.hx",276,0x953dc7b7)
...
HXLINE(  56)		{
HXLINE(  56)			 ::flixel::text::FlxText _g = levelInfo;
HXDLIN(  56)			_g->set_text(( (::String)((_g->text + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic))) ));
            		}
...
HXLINE(  63)		{
HXLINE(  63)			 ::flixel::text::FlxText _g1 = levelDifficulty;
HXDLIN(  63)			::String _g2 = _g1->text;
HXDLIN(  63)			_g1->set_text((_g2 + ::CoolUtil_obj::difficultyFromInt(::PlayState_obj::storyDifficulty).toUpperCase()));
            		}
...
HXLINE(  89)		{
HXLINE(  89)			int _g3 = 0;
HXDLIN(  89)			int _g4 = this->menuItems->length;
HXDLIN(  89)			while((_g3 < _g4)){
HXLINE(  89)				_g3 = (_g3 + 1);
HXDLIN(  89)				int i = (_g3 - 1);
HXLINE(  91)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null(),null(),null());
...
HXLINE( 105)			 ::flixel::_hx_system::FlxSound _g = this->pauseMusic;
HXDLIN( 105)			_g->set_volume((_g->_volume + (((Float)0.01) * elapsed)));
            		}
...
HXLINE( 114)		bool upPcontroller = false;
HXLINE( 115)		bool downPcontroller = false;
HXLINE( 116)		bool leftPcontroller = false;
HXLINE( 117)		bool rightPcontroller = false;
HXLINE( 118)		Float oldOffset = ( (Float)(0) );
HXLINE( 120)		bool _hx_tmp;
HXDLIN( 120)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 120)			_hx_tmp = ::KeyBinds_obj::gamepad;
            		}
            		else {
HXLINE( 120)			_hx_tmp = false;
            		}
HXDLIN( 120)		if (_hx_tmp) {
HXLINE( 122)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 122)			int id = 11;
HXDLIN( 122)			 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 122)			int Status = _this->status;
HXDLIN( 122)			switch((int)(id)){
            				case (int)-2: {
HXLINE( 122)					upPcontroller = _this1->anyButton(Status);
            				}
            				break;
            				case (int)-1: {
HXLINE( 122)					upPcontroller = !(_this1->anyButton(Status));
            				...
            				break;
            				default:{
HXLINE( 122)					int RawID = _this1->mapping->getRawID(id);
HXDLIN( 122)					 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 122)					if (::hx::IsNotNull( button )) {
HXLINE( 122)						upPcontroller = button->hasState(Status);
            					}
            					else {
HXLINE( 122)						upPcontroller = false;
            					}
            				}
            			}
HXLINE( 123)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this2 = gamepad->justPressed;
HXDLIN( 123)			int id1 = 12;
HXDLIN( 123)			 ::flixel::input::gamepad::FlxGamepad _this3 = _this2->gamepad;
HXDLIN( 123)			int Status1 = _this2->status;
HXDLIN( 123)			switch((int)(id1)){
            				case (int)-2: {
HXLINE( 123)					downPcontroller = _this3->anyButton(Status1);
            				}
            				break;
            				case (int)-1: {
HXLINE( 123)					downPcontroller = !(_this3->anyButton(Status1));
            				...
            				break;
            				default:{
HXLINE( 123)					int RawID = _this3->mapping->getRawID(id1);
HXDLIN( 123)					 ::flixel::input::gamepad::FlxGamepadButton button = _this3->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 123)					if (::hx::IsNotNull( button )) {
HXLINE( 123)						downPcontroller = button->hasState(Status1);
            					}
            					else {
HXLINE( 123)						downPcontroller = false;
            					}
            				}
            			}
HXLINE( 124)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this4 = gamepad->justPressed;
HXDLIN( 124)			int id2 = 13;
HXDLIN( 124)			 ::flixel::input::gamepad::FlxGamepad _this5 = _this4->gamepad;
HXDLIN( 124)			int Status2 = _this4->status;
HXDLIN( 124)			switch((int)(id2)){
            				case (int)-2: {
HXLINE( 124)					leftPcontroller = _this5->anyButton(Status2);
            				}
            				break;
            				case (int)-1: {
HXLINE( 124)					leftPcontroller = !(_this5->anyButton(Status2));
            				...
            				break;
            				default:{
HXLINE( 124)					int RawID = _this5->mapping->getRawID(id2);
HXDLIN( 124)					 ::flixel::input::gamepad::FlxGamepadButton button = _this5->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 124)					if (::hx::IsNotNull( button )) {
HXLINE( 124)						leftPcontroller = button->hasState(Status2);
            					}
            					else {
HXLINE( 124)						leftPcontroller = false;
            					}
            				}
            			}
HXLINE( 125)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this6 = gamepad->justPressed;
HXDLIN( 125)			int id3 = 14;
HXDLIN( 125)			 ::flixel::input::gamepad::FlxGamepad _this7 = _this6->gamepad;
HXDLIN( 125)			int Status3 = _this6->status;
HXDLIN( 125)			switch((int)(id3)){
            				case (int)-2: {
HXLINE( 125)					rightPcontroller = _this7->anyButton(Status3);
            				}
            				break;
            				case (int)-1: {
HXLINE( 125)					rightPcontroller = !(_this7->anyButton(Status3));
            				...
            				break;
            				default:{
HXLINE( 125)					int RawID = _this7->mapping->getRawID(id3);
HXDLIN( 125)					 ::flixel::input::gamepad::FlxGamepadButton button = _this7->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 125)					if (::hx::IsNotNull( button )) {
HXLINE( 125)						rightPcontroller = button->hasState(Status3);
            					}
            					else {
HXLINE( 125)						rightPcontroller = false;
            					}
            				}
            			}
            		}
HXLINE( 129)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 130)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 131)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 131)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 132)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 132)			goto _hx_goto_3;
            		}
            		_hx_goto_3:;
HXLINE( 134)		::String songPath = ((HX_("assets/data/",f9,10,73,a0) + songLowercase) + HX_("/",2f,00,00,00));
HXLINE( 137)		bool _hx_tmp1;
HXDLIN( 137)		if (::PlayState_obj::isSM) {
HXLINE( 137)			_hx_tmp1 = !(::PlayState_obj::isStoryMode);
            		}
            		else {
HXLINE( 137)			_hx_tmp1 = false;
            		}
HXDLIN( 137)		if (_hx_tmp1) {
HXLINE( 138)			songPath = ::PlayState_obj::pathToSm;
            		}
HXLINE( 141)		bool _hx_tmp2;
HXDLIN( 141)		if (!(::PlayerSettings_obj::player1->controls->_upP->check())) {
HXLINE( 141)			_hx_tmp2 = upPcontroller;
            		}
            		else {
...
HXDLIN( 146)			if (!(::PlayerSettings_obj::player1->controls->_downP->check())) {
HXLINE( 146)				_hx_tmp = downPcontroller;
            			}
            			else {
...
HXDLIN( 152)				if (!(::PlayerSettings_obj::player1->controls->_leftP->check())) {
HXLINE( 152)					_hx_tmp = leftPcontroller;
            				}
            				else {
HXLINE( 152)					_hx_tmp = true;
            				}
HXDLIN( 152)				if (_hx_tmp) {
HXLINE( 154)					oldOffset = ::PlayState_obj::songOffset;
HXLINE( 155)					 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN( 155)					::PlayState_obj::songOffset = (::PlayState_obj::songOffset - ( (Float)(1) ));
HXLINE( 156)					::sys::FileSystem_obj::rename(((songPath + oldOffset) + HX_(".offset",41,ee,1a,d9)),((songPath + ::PlayState_obj::songOffset) + HX_(".offset",41,ee,1a,d9)));
HXLINE( 157)					this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
...
HXLINE( 168)								 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null(),null(),null());
...
HXDLIN( 180)					if (!(::PlayerSettings_obj::player1->controls->_rightP->check())) {
HXLINE( 180)						_hx_tmp = rightPcontroller;
            					}
            					else {
HXLINE( 180)						_hx_tmp = true;
            					}
HXDLIN( 180)					if (_hx_tmp) {
HXLINE( 182)						oldOffset = ::PlayState_obj::songOffset;
HXLINE( 183)						 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN( 183)						::PlayState_obj::songOffset = (::PlayState_obj::songOffset + 1);
HXLINE( 184)						::sys::FileSystem_obj::rename(((songPath + oldOffset) + HX_(".offset",41,ee,1a,d9)),((songPath + ::PlayState_obj::songOffset) + HX_(".offset",41,ee,1a,d9)));
HXLINE( 185)						this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
HXLINE( 186)						if (!(this->offsetChanged)) {
HXLINE( 188)							this->grpMenuShit->clear();
HXLINE( 190)							this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_9,2);
HXLINE( 192)							{
HXLINE( 192)								int _g = 0;
HXDLIN( 192)								int _g1 = this->menuItems->length;
HXDLIN( 192)								while((_g < _g1)){
HXLINE( 192)									_g = (_g + 1);
HXDLIN( 192)									int i = (_g - 1);
HXLINE( 194)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null(),null(),null());
HXLINE( 195)									songText->isMenuItem = true;
HXLINE( 196)									songText->targetY = ( (Float)(i) );
HXLINE( 197)									this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            								}
            							}
HXLINE( 200)							this->changeSelection(null());
HXLINE( 202)							this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 203)							this->offsetChanged = true;
            						}
            					}
            				}
            			}
            		}
HXLINE( 208)		bool _hx_tmp3;
HXDLIN( 208)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 208)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 208)			_hx_tmp3 = !(_this->keyManager->checkStatus(18,_this->status));
            		}
            		else {
HXLINE( 208)			_hx_tmp3 = false;
            		}
HXDLIN( 208)		if (_hx_tmp3) {
HXLINE( 210)			::String daSelected = this->menuItems->__get(this->curSelected);
HXLINE( 213)			::String _hx_switch_1 = daSelected;
            			if (  (_hx_switch_1==HX_("Exit to menu",82,87,9a,a9)) ){
HXLINE( 228)				::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 229)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 231)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 232)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 233)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 235)				if (::PlayState_obj::loadRep) {
HXLINE( 237)					::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),false,::hx::paccDynamic);
HXLINE( 238)					::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
HXLINE( 239)					::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),false,::hx::paccDynamic);
            				}
HXLINE( 241)				::PlayState_obj::loadRep = false;
HXLINE( 243)				if (::hx::IsNotNull( ::PlayState_obj::luaModchart )) {
HXLINE( 245)					::PlayState_obj::luaModchart->die();
HXLINE( 246)					::PlayState_obj::luaModchart = null();
            				}
HXLINE( 249)				if (::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),290 )) {
HXLINE( 250)					::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(290) ));
            				}
HXLINE( 252)				::PlayState_obj::instance->clean();
...
HXLINE( 257)					 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 218)				::PlayState_obj::startTime = ( (Float)(0) );
...
HXLINE( 225)				::PlayState_obj::instance->clean();
HXLINE( 226)				{
...
HXDLIN( 261)		bool _hx_tmp4 = _this->keyManager->checkStatus(74,_this->status);
            	}


void PauseSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_269_destroy)
HXLINE( 270)		this->pauseMusic->destroy();
...
void PauseSubState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_276_changeSelection)
HXLINE( 277)		 ::PauseSubState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 277)		_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 279)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN( 279)		_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 281)		if ((this->curSelected < 0)) {
HXLINE( 282)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 283)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 284)			this->curSelected = 0;
            		}
HXLINE( 286)		int bullShit = 0;
HXLINE( 288)		{
HXLINE( 288)			int _g = 0;
HXDLIN( 288)			::Array< ::Dynamic> _g1 = this->grpMenuShit->members;
HXDLIN( 288)			while((_g < _g1->length)){
HXLINE( 288)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 288)				_g = (_g + 1);
HXLINE( 290)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 291)				bullShit = (bullShit + 1);
HXLINE( 293)				item->set_alpha(((Float)0.6));
HXLINE( 296)				if ((item->targetY == 0)) {
HXLINE( 298)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
