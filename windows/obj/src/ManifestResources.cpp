...
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_dominican_ttf
#include <__ASSET__OPENFL__assets_fonts_dominican_ttf.h>
#endif
...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_acme_____ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_dominican_ttf >());
HXLINE(  55)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_otf >());
HXLINE(  56)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_vcr_ttf >());
...
HXLINE(  75)		{
HXLINE(  75)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  76)		{
HXLINE(  76)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  77)		{
HXLINE(  77)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/tutorial.json",58,c3,5d,36));
HXDLIN(  77)			::lime::utils::Assets_obj::libraryPaths->set(HX_("tutorial",9e,8f,b5,82),v2);
            		}
HXLINE(  78)		{
HXLINE(  78)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/weekali.json",0c,cd,47,c3));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("weekali",aa,09,02,25),v3);
            		}
HXLINE(  79)		{
HXLINE(  79)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/sm.json",dc,54,48,0c));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("sm",9a,64,00,00),v4);
            		}
HXLINE(  80)		{
HXLINE(  80)			::String v5 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v5);
            		}
HXLINE(  62)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  84)		if (::hx::IsNotNull( library )) {
HXLINE(  84)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  85)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  86)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  87)		if (::hx::IsNotNull( library )) {
HXLINE(  87)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  88)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE(  89)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  90)		if (::hx::IsNotNull( library )) {
HXLINE(  90)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  91)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  92)		library = ::lime::utils::Assets_obj::getLibrary(HX_("weekali",aa,09,02,25));
HXLINE(  93)		if (::hx::IsNotNull( library )) {
HXLINE(  93)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  94)			::ManifestResources_obj::preloadLibraryNames->push(HX_("weekali",aa,09,02,25));
            		}
HXLINE(  95)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sm",9a,64,00,00));
HXLINE(  96)		if (::hx::IsNotNull( library )) {
HXLINE(  96)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  97)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sm",9a,64,00,00));
            		}
HXLINE(  98)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  99)		if (::hx::IsNotNull( library )) {
HXLINE(  99)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 100)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
