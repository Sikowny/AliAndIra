...
HX_LOCAL_STACK_FRAME(_hx_pos_1f137c4d6a266f48_187_logEvent,"NGio","logEvent",0x006d7ee5,"NGio.logEvent","NGio.hx",187,0xcd75a7bf)
...
void NGio_obj::logEvent(::String event){
            	HX_STACKFRAME(&_hx_pos_1f137c4d6a266f48_187_logEvent)
HXDLIN( 187)		::io::newgrounds::NG_obj::core->calls->event->logEvent(event)->send();
            	}
