...
HX_DEFINE_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_293_new,"StepManiaOption","new",0x8fd4a86d,"StepManiaOption.new","Options.hx",293,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_298_press,"StepManiaOption","press",0xdbf908d0,"StepManiaOption.press","Options.hx",298,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d26a84dfc1aa5e2f_306_updateDisplay,"StepManiaOption","updateDisplay",0xac02d986,"StepManiaOption.updateDisplay","Options.hx",306,0x9d9a0240)

void StepManiaOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_293_new)
HXLINE( 294)		super::__construct();
HXLINE( 295)		this->description = desc;
            	}
...
bool StepManiaOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_298_press)
HXLINE( 299)		::flixel::FlxG_obj::save->data->__SetField(HX_("stepMania",06,56,8a,73),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 300)		this->display = this->updateDisplay();
HXLINE( 301)		return true;
            	}


::String StepManiaOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_d26a84dfc1aa5e2f_306_updateDisplay)
HXDLIN( 306)		::String _hx_tmp;
HXDLIN( 306)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) ))) {
HXDLIN( 306)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 306)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 306)		return (HX_("Colors by quantization ",46,94,48,67) + _hx_tmp);
            	}
