...
HX_DEFINE_STACK_FRAME(_hx_pos_7861c1e414cf422e_635_new,"RainbowFPSOption","new",0xb4ce913a,"RainbowFPSOption.new","Options.hx",635,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_641_press,"RainbowFPSOption","press",0xa1d87edd,"RainbowFPSOption.press","Options.hx",641,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_650_updateDisplay,"RainbowFPSOption","updateDisplay",0xe58aa493,"RainbowFPSOption.updateDisplay","Options.hx",650,0x9d9a0240)

void RainbowFPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_635_new)
HXLINE( 636)		super::__construct();
HXLINE( 637)		this->description = desc;
            	}
...
bool RainbowFPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_641_press)
HXLINE( 642)		::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 643)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->changeFPSColor(-1);
HXLINE( 644)		this->display = this->updateDisplay();
HXLINE( 645)		return true;
            	}


::String RainbowFPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_650_updateDisplay)
HXDLIN( 650)		::String _hx_tmp;
HXDLIN( 650)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) ))) {
HXDLIN( 650)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 650)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 650)		return (HX_("FPS Rainbow ",81,45,9e,9c) + _hx_tmp);
            	}
