...
HXLINE(  31)				{
HXLINE(  31)					int _g1 = 0;
HXDLIN(  31)					int _g2 = ( (::Array< ::Dynamic>)( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) )->length;
HXDLIN(  31)					while((_g1 < _g2)){
HXLINE(  31)						_g1 = (_g1 + 1);
HXDLIN(  31)						int ii = (_g1 - 1);
HXLINE(  33)						::cpp::VirtualArray n = ( (::cpp::VirtualArray)( ::Dynamic( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic))->__GetItem(ii)) );
HXLINE(  34)						if (::hx::IsLessEq( n->__get(1),0 )) {
...
HXLINE(  47)				{
HXLINE(  47)					int _g1 = 0;
HXDLIN(  47)					int _g2 = ( (::Array< ::Dynamic>)( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) )->length;
HXDLIN(  47)					while((_g1 < _g2)){
HXLINE(  47)						_g1 = (_g1 + 1);
HXDLIN(  47)						int ii = (_g1 - 1);
HXLINE(  49)						::cpp::VirtualArray n = ( (::cpp::VirtualArray)( ::Dynamic( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic))->__GetItem(ii)) );
HXLINE(  51)						if (::hx::IsGreater( n->__get(1),0 )) {
