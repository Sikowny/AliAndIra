...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_285_addSong,"FreeplayState","addSong",0x9e966259,"FreeplayState.addSong","FreeplayState.hx",285,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_289_addWeek,"FreeplayState","addWeek",0xa1339e78,"FreeplayState.addWeek","FreeplayState.hx",289,0x0d86f62d)
...
HXDLIN(  88)					goto _hx_goto_2;
            				...
            				_hx_goto_2:;
HXLINE(  91)				::Array< ::Dynamic> diffs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  92)				::Array< ::String > diffsThatExist = ::Array_obj< ::String >::__new(0);
HXLINE(  96)				if (::sys::FileSystem_obj::exists(((((HX_("assets/data/",f9,10,73,a0) + format) + HX_("/",2f,00,00,00)) + format) + HX_("-hard.json",be,e0,5c,6e)))) {
HXLINE(  97)					diffsThatExist->push(HX_("Hard",0b,5b,e1,2f));
            				}
HXLINE(  98)				if (::sys::FileSystem_obj::exists(((((HX_("assets/data/",f9,10,73,a0) + format) + HX_("/",2f,00,00,00)) + format) + HX_("-easy.json",47,b0,9c,84)))) {
HXLINE(  99)					diffsThatExist->push(HX_("Easy",22,b8,e5,2d));
            				}
HXLINE( 100)				if (::sys::FileSystem_obj::exists(((((HX_("assets/data/",f9,10,73,a0) + format) + HX_("/",2f,00,00,00)) + format) + HX_(".json",56,f1,d6,c2)))) {
HXLINE( 101)					diffsThatExist->push(HX_("Normal",47,e6,fd,64));
            				}
HXLINE( 103)				if ((diffsThatExist->length == 0)) {
HXLINE( 105)					::lime::app::Application_obj::current->_hx___window->alert(HX_("No difficulties found for chart, skipping.",c8,d7,62,53),(meta1->songName + HX_(" Chart",9e,98,4c,a4)));
HXLINE( 106)					continue;
            				}
HXLINE( 111)				if (diffsThatExist->contains(HX_("Easy",22,b8,e5,2d))) {
HXLINE( 112)					::FreeplayState_obj::loadDiff(0,format,meta1->songName,diffs);
            				}
HXLINE( 113)				if (diffsThatExist->contains(HX_("Normal",47,e6,fd,64))) {
HXLINE( 114)					::FreeplayState_obj::loadDiff(1,format,meta1->songName,diffs);
            				}
HXLINE( 115)				if (diffsThatExist->contains(HX_("Hard",0b,5b,e1,2f))) {
HXLINE( 116)					::FreeplayState_obj::loadDiff(2,format,meta1->songName,diffs);
            				}
HXLINE( 118)				meta1->diffs = diffsThatExist;
HXLINE( 120)				bool _hx_tmp = (diffsThatExist->length != 3);
HXLINE( 123)				::FreeplayState_obj::songData->set(meta1->songName,diffs);
HXLINE( 125)				::FreeplayState_obj::songs->push(meta1);
            			}
            		}
HXLINE( 132)		{
HXLINE( 132)			int _g2 = 0;
HXDLIN( 132)			::Array< ::String > _g3 = ::sys::FileSystem_obj::readDirectory(HX_("assets/sm/",89,ef,2d,70));
HXDLIN( 132)			while((_g2 < _g3->length)){
HXLINE( 132)				::String i = _g3->__get(_g2);
HXDLIN( 132)				_g2 = (_g2 + 1);
HXLINE( 135)				if (::sys::FileSystem_obj::isDirectory((HX_("assets/sm/",89,ef,2d,70) + i))) {
HXLINE( 138)					int _g = 0;
HXDLIN( 138)					::Array< ::String > _g1 = ::sys::FileSystem_obj::readDirectory((HX_("assets/sm/",89,ef,2d,70) + i));
HXDLIN( 138)					while((_g < _g1->length)){
HXLINE( 138)						::String file = _g1->__get(_g);
HXDLIN( 138)						_g = (_g + 1);
HXLINE( 140)						if ((file.indexOf(HX_(" ",20,00,00,00),null()) != -1)) {
HXLINE( 141)							::sys::FileSystem_obj::rename((((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/",2f,00,00,00)) + file),(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/",2f,00,00,00)) + ::StringTools_obj::replace(file,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00))));
            						}
HXLINE( 142)						bool _hx_tmp;
HXDLIN( 142)						if (::StringTools_obj::endsWith(file,HX_(".sm",48,4c,23,00))) {
HXLINE( 142)							_hx_tmp = !(::sys::FileSystem_obj::exists(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/converted.json",73,2b,b3,66))));
            						}
            						else {
HXLINE( 142)							_hx_tmp = false;
            						}
HXDLIN( 142)						if (_hx_tmp) {
HXLINE( 145)							 ::smTools::SMFile file1 = ::smTools::SMFile_obj::loadFile((((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/",2f,00,00,00)) + ::StringTools_obj::replace(file,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00))));
HXLINE( 147)							::String data = file1->convertToFNF(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/converted.json",73,2b,b3,66)));
HXLINE( 148)							 ::SongMetadata meta =  ::SongMetadata_obj::__alloc( HX_CTX ,file1->header->TITLE,0,HX_("sm",9a,64,00,00),file1,(HX_("assets/sm/",89,ef,2d,70) + i));
HXLINE( 149)							::FreeplayState_obj::songs->push(meta);
HXLINE( 150)							 ::Dynamic song = ::Song_obj::loadFromJsonRAW(data);
HXLINE( 151)							::FreeplayState_obj::songData->set(file1->header->TITLE,::Array_obj< ::Dynamic>::__new(3)->init(0,song)->init(1,song)->init(2,song));
            						}
            						else {
HXLINE( 153)							bool _hx_tmp;
HXDLIN( 153)							if (::sys::FileSystem_obj::exists(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/converted.json",73,2b,b3,66)))) {
HXLINE( 153)								_hx_tmp = ::StringTools_obj::endsWith(file,HX_(".sm",48,4c,23,00));
            							}
            							else {
HXLINE( 153)								_hx_tmp = false;
            							}
HXDLIN( 153)							if (_hx_tmp) {
HXLINE( 156)								 ::smTools::SMFile file1 = ::smTools::SMFile_obj::loadFile((((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/",2f,00,00,00)) + ::StringTools_obj::replace(file,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00))));
HXLINE( 158)								::String data = file1->convertToFNF(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/converted.json",73,2b,b3,66)));
HXLINE( 159)								 ::SongMetadata meta =  ::SongMetadata_obj::__alloc( HX_CTX ,file1->header->TITLE,0,HX_("sm",9a,64,00,00),file1,(HX_("assets/sm/",89,ef,2d,70) + i));
HXLINE( 160)								::FreeplayState_obj::songs->push(meta);
HXLINE( 161)								 ::Dynamic song = ::Song_obj::loadFromJsonRAW(::sys::io::File_obj::getContent(((HX_("assets/sm/",89,ef,2d,70) + i) + HX_("/converted.json",73,2b,b3,66))));
HXLINE( 163)								::FreeplayState_obj::songData->set(file1->header->TITLE,::Array_obj< ::Dynamic>::__new(3)->init(0,song)->init(1,song)->init(2,song));
            							}
            						}
            					}
            				}
...
HXLINE( 182)		::DiscordClient_obj::changePresence(HX_("In the Freeplay Menu",55,4e,8a,46),null(),null(),null(),null());
HXLINE( 185)		bool isDebug = false;
HXLINE( 191)		this->persistentUpdate = true;
HXLINE( 197)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN( 197)		::String library1 = null();
HXDLIN( 197)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBGBlue",de,35,e3,1e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 198)		bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 199)		this->add(bg1);
HXLINE( 201)		this->grpSongs =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 202)		this->add(this->grpSongs);
HXLINE( 204)		{
HXLINE( 204)			int _g4 = 0;
HXDLIN( 204)			int _g5 = ::FreeplayState_obj::songs->length;
HXDLIN( 204)			while((_g4 < _g5)){
HXLINE( 204)				_g4 = (_g4 + 1);
HXDLIN( 204)				int i = (_g4 - 1);
HXLINE( 206)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),::FreeplayState_obj::songs->__get(i).StaticCast<  ::SongMetadata >()->songName,true,false,true,null(),null());
HXLINE( 207)				songText->isMenuItem = true;
HXLINE( 208)				songText->targetY = ( (Float)(i) );
HXLINE( 209)				this->grpSongs->add(songText).StaticCast<  ::Alphabet >();
HXLINE( 211)				 ::HealthIcon icon =  ::HealthIcon_obj::__alloc( HX_CTX ,::FreeplayState_obj::songs->__get(i).StaticCast<  ::SongMetadata >()->songCharacter,null());
HXLINE( 212)				icon->sprTracker = songText;
HXLINE( 215)				this->iconArray->push(icon);
HXLINE( 216)				this->add(icon);
            			}
            		}
HXLINE( 223)		this->scoreText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.7)),5,0,HX_("",00,00,00,00),32,null());
HXLINE( 225)		this->scoreText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("right",dc,0b,64,e9),null(),null(),null());
HXLINE( 228)		 ::flixel::FlxSprite scoreBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(this->scoreText->x - ( (Float)(6) )),0,null());
HXDLIN( 228)		 ::flixel::FlxSprite scoreBG1 = scoreBG->makeGraphic(::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))),135,-16777216,null(),null());
HXLINE( 229)		scoreBG1->set_alpha(((Float)0.6));
HXLINE( 230)		this->add(scoreBG1);
HXLINE( 232)		this->diffText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->scoreText->x,(this->scoreText->y + 36),0,HX_("",00,00,00,00),24,null());
HXLINE( 233)		this->diffText->set_font(this->scoreText->_font);
HXLINE( 234)		this->add(this->diffText);
HXLINE( 236)		this->diffCalcText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->scoreText->x,(this->scoreText->y + 66),0,HX_("",00,00,00,00),24,null());
HXLINE( 237)		this->diffCalcText->set_font(this->scoreText->_font);
HXLINE( 238)		this->add(this->diffCalcText);
HXLINE( 240)		this->previewtext =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->scoreText->x,(this->scoreText->y + 94),0,((HX_("Rate: ",a6,71,1b,f0) + ::FreeplayState_obj::rate) + HX_("x",78,00,00,00)),24,null());
HXLINE( 241)		this->previewtext->set_font(this->scoreText->_font);
HXLINE( 242)		this->add(this->previewtext);
HXLINE( 244)		this->comboText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->diffText->x + 100),this->diffText->y,0,HX_("",00,00,00,00),24,null());
HXLINE( 245)		this->comboText->set_font(this->diffText->_font);
HXLINE( 246)		this->add(this->comboText);
HXLINE( 248)		this->add(this->scoreText);
HXLINE( 250)		this->changeSelection(null());
HXLINE( 251)		this->changeDiff(null());
HXLINE( 255)		this->selector =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 257)		this->selector->set_size(40);
HXLINE( 258)		this->selector->set_text(HX_(">",3e,00,00,00));
HXLINE( 261)		 ::Alphabet swag =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(1) ),( (Float)(0) ),HX_("swag",8a,2a,5e,4c),null(),null(),null(),null(),null());
HXLINE( 280)		this->super::create();
            	}


void FreeplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_285_addSong)
HXDLIN( 285)		::Array< ::Dynamic> _hx_tmp = ::FreeplayState_obj::songs;
HXDLIN( 285)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter,null(),null()));
            	}
...
void FreeplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_289_addWeek)
HXLINE( 290)		if (::hx::IsNull( songCharacters )) {
HXLINE( 291)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_10,1);
            		}
HXLINE( 293)		int num = 0;
HXLINE( 294)		{
HXLINE( 294)			int _g = 0;
HXDLIN( 294)			while((_g < songs->length)){
HXLINE( 294)				::String song = songs->__get(_g);
HXDLIN( 294)				_g = (_g + 1);
HXLINE( 296)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 298)				if ((songCharacters->length != 1)) {
HXLINE( 299)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void FreeplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_304_update)
HXLINE( 305)		this->super::update(elapsed);
HXLINE( 307)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 309)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 309)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 312)		Float a = ( (Float)(this->lerpScore) );
HXDLIN( 312)		this->lerpScore = ::Math_obj::floor((a + (((Float)0.4) * (( (Float)(this->intendedScore) ) - a))));
HXLINE( 314)		if ((::Math_obj::abs(( (Float)((this->lerpScore - this->intendedScore)) )) <= 10)) {
HXLINE( 315)			this->lerpScore = this->intendedScore;
            		}
HXLINE( 317)		this->scoreText->set_text((HX_("PERSONAL BEST:",36,ce,e9,ee) + this->lerpScore));
HXLINE( 318)		this->comboText->set_text((this->combo + HX_("\n",0a,00,00,00)));
HXLINE( 320)		if ((::flixel::FlxG_obj::sound->music->_volume > ((Float)0.8))) {
HXLINE( 322)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 322)			_g->set_volume((_g->_volume - (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 325)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 325)		bool upP = _this->keyManager->checkStatus(38,_this->status);
HXLINE( 326)		 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 326)		bool downP = _this1->keyManager->checkStatus(40,_this1->status);
HXLINE( 327)		 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 327)		bool accepted = _this2->keyManager->checkStatus(13,_this2->status);
HXLINE( 329)		 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->lastActive;
HXLINE( 331)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 334)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 334)			int id = 11;
HXDLIN( 334)			 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 334)			int Status = _this->status;
HXDLIN( 334)			bool _hx_tmp;
HXDLIN( 334)			switch((int)(id)){
            				case (int)-2: {
HXLINE( 334)					_hx_tmp = _this1->anyButton(Status);
            				}
            				break;
            				case (int)-1: {
HXLINE( 334)					_hx_tmp = !(_this1->anyButton(Status));
            				...
            				break;
            				default:{
HXLINE( 334)					int RawID = _this1->mapping->getRawID(id);
HXDLIN( 334)					 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 334)					if (::hx::IsNotNull( button )) {
HXLINE( 334)						_hx_tmp = button->hasState(Status);
            					}
            					else {
...
HXLINE( 336)				this->changeSelection(-1);
            			}
HXLINE( 338)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this2 = gamepad->justPressed;
HXDLIN( 338)			int id1 = 12;
HXDLIN( 338)			 ::flixel::input::gamepad::FlxGamepad _this3 = _this2->gamepad;
HXDLIN( 338)			int Status1 = _this2->status;
HXDLIN( 338)			bool _hx_tmp1;
HXDLIN( 338)			switch((int)(id1)){
            				case (int)-2: {
HXLINE( 338)					_hx_tmp1 = _this3->anyButton(Status1);
            				}
            				break;
            				case (int)-1: {
HXLINE( 338)					_hx_tmp1 = !(_this3->anyButton(Status1));
            				...
            				break;
            				default:{
HXLINE( 338)					int RawID = _this3->mapping->getRawID(id1);
HXDLIN( 338)					 ::flixel::input::gamepad::FlxGamepadButton button = _this3->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 338)					if (::hx::IsNotNull( button )) {
HXLINE( 338)						_hx_tmp1 = button->hasState(Status1);
            					}
            					else {
...
HXLINE( 340)				this->changeSelection(1);
            			}
HXLINE( 342)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this4 = gamepad->justPressed;
HXDLIN( 342)			int id2 = 13;
HXDLIN( 342)			 ::flixel::input::gamepad::FlxGamepad _this5 = _this4->gamepad;
HXDLIN( 342)			int Status2 = _this4->status;
HXDLIN( 342)			bool _hx_tmp2;
HXDLIN( 342)			switch((int)(id2)){
            				case (int)-2: {
HXLINE( 342)					_hx_tmp2 = _this5->anyButton(Status2);
            				}
            				break;
            				case (int)-1: {
HXLINE( 342)					_hx_tmp2 = !(_this5->anyButton(Status2));
            				...
            				break;
            				default:{
HXLINE( 342)					int RawID = _this5->mapping->getRawID(id2);
HXDLIN( 342)					 ::flixel::input::gamepad::FlxGamepadButton button = _this5->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 342)					if (::hx::IsNotNull( button )) {
HXLINE( 342)						_hx_tmp2 = button->hasState(Status2);
            					}
            					else {
...
HXLINE( 344)				this->changeDiff(-1);
            			}
HXLINE( 346)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this6 = gamepad->justPressed;
HXDLIN( 346)			int id3 = 14;
HXDLIN( 346)			 ::flixel::input::gamepad::FlxGamepad _this7 = _this6->gamepad;
HXDLIN( 346)			int Status3 = _this6->status;
HXDLIN( 346)			bool _hx_tmp3;
HXDLIN( 346)			switch((int)(id3)){
            				case (int)-2: {
HXLINE( 346)					_hx_tmp3 = _this7->anyButton(Status3);
            				}
            				break;
            				case (int)-1: {
HXLINE( 346)					_hx_tmp3 = !(_this7->anyButton(Status3));
            				...
            				break;
            				default:{
HXLINE( 346)					int RawID = _this7->mapping->getRawID(id3);
HXDLIN( 346)					 ::flixel::input::gamepad::FlxGamepadButton button = _this7->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 346)					if (::hx::IsNotNull( button )) {
HXLINE( 346)						_hx_tmp3 = button->hasState(Status3);
            					}
            					else {
...
HXLINE( 348)				this->changeDiff(1);
            			}
            		}
HXLINE( 355)		if (upP) {
HXLINE( 357)			this->changeSelection(-1);
            		}
HXLINE( 359)		if (downP) {
HXLINE( 361)			this->changeSelection(1);
            		}
HXLINE( 367)		 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 367)		if (_this3->keyManager->checkStatus(16,_this3->status)) {
HXLINE( 369)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 369)			if (_this->keyManager->checkStatus(37,_this->status)) {
HXLINE( 371)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 371)				::FreeplayState_obj::rate = (::FreeplayState_obj::rate - ((Float)0.05));
HXLINE( 372)				 ::flixel::text::FlxText _hx_tmp1 = this->diffCalcText;
HXDLIN( 372)				_hx_tmp1->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
HXLINE( 374)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 374)			if (_this1->keyManager->checkStatus(39,_this1->status)) {
HXLINE( 376)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 376)				::FreeplayState_obj::rate = (::FreeplayState_obj::rate + ((Float)0.05));
HXLINE( 377)				 ::flixel::text::FlxText _hx_tmp1 = this->diffCalcText;
HXDLIN( 377)				_hx_tmp1->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
HXLINE( 380)			if ((::FreeplayState_obj::rate > 3)) {
HXLINE( 382)				::FreeplayState_obj::rate = ( (Float)(3) );
HXLINE( 383)				 ::flixel::text::FlxText _hx_tmp = this->diffCalcText;
HXDLIN( 383)				_hx_tmp->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
            			else {
HXLINE( 385)				if ((::FreeplayState_obj::rate < ((Float)0.5))) {
HXLINE( 387)					::FreeplayState_obj::rate = ((Float)0.5);
HXLINE( 388)					 ::flixel::text::FlxText _hx_tmp = this->diffCalcText;
HXDLIN( 388)					_hx_tmp->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            				}
            			}
HXLINE( 391)			this->previewtext->set_text(((HX_("Rate: ",a6,71,1b,f0) + ::FreeplayState_obj::rate) + HX_("x",78,00,00,00)));
            		}
            		else {
HXLINE( 395)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 395)			if (_this->keyManager->checkStatus(37,_this->status)) {
HXLINE( 396)				this->changeDiff(-1);
            			}
HXLINE( 397)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 397)			if (_this1->keyManager->checkStatus(39,_this1->status)) {
HXLINE( 398)				this->changeDiff(1);
            			}
            		}
HXLINE( 405)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 406)			::lime::media::openal::AL_obj::sourcef(::flixel::FlxG_obj::sound->music->_channel->_hx___source->_hx___backend->handle,4099,::FreeplayState_obj::rate);
            		}
HXLINE( 410)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 412)			 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 412)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 412)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 415)		if (accepted) {
HXLINE( 418)			::String songFormat = ::StringTools_obj::replace(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 419)			::String _hx_switch_0 = songFormat;
            			if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 420)				songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 420)				goto _hx_goto_11;
            			}
            			if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 421)				songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 421)				goto _hx_goto_11;
            			}
            			_hx_goto_11:;
HXLINE( 423)			 ::Dynamic hmm;
HXLINE( 424)			try {
...
HXLINE( 538)		 ::flixel::text::FlxText _hx_tmp2 = this->diffCalcText;
HXDLIN( 538)		_hx_tmp2->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
HXLINE( 539)		 ::flixel::text::FlxText _hx_tmp3 = this->diffText;
HXDLIN( 539)		_hx_tmp3->set_text(::CoolUtil_obj::difficultyFromInt(::FreeplayState_obj::curDifficulty).toUpperCase());
HXLINE( 542)		if ((::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songCharacter == HX_("sm",9a,64,00,00))) {
HXLINE( 544)			 ::SongMetadata data = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >();
HXLINE( 546)			 ::haxe::io::Bytes bytes = ::sys::io::File_obj::getBytes(((data->path + HX_("/",2f,00,00,00)) + data->sm->header->MUSIC));
HXLINE( 547)			 ::openfl::media::Sound sound =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 548)			sound->loadCompressedDataFromByteArray(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytesData(bytes->b),bytes->length);
HXLINE( 549)			::flixel::FlxG_obj::sound->playMusic(sound,null(),null(),null());
            		}
            		else {
HXLINE( 552)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 552)			::String songLowercase = ::StringTools_obj::replace(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 552)			::String _hx_switch_2 = songLowercase;
            			if (  (_hx_switch_2==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 552)				songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 552)				goto _hx_goto_17;
            			}
            			if (  (_hx_switch_2==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 552)				songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 552)				goto _hx_goto_17;
            			}
            			_hx_goto_17:;
HXDLIN( 552)			_hx_tmp->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
            		}
HXLINE( 555)		 ::Dynamic hmm;
HXLINE( 556)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 558)			hmm = ::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::SongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty);
HXLINE( 559)			if (::hx::IsNotNull( hmm )) {
HXLINE( 560)				::Conductor_obj::changeBPM(( (Float)(hmm->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) ),null());
            			}
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
...
HXLINE( 565)		if (::FreeplayState_obj::openedPreview) {
HXLINE( 567)			this->closeSubState();
HXLINE( 568)			this->openSubState( ::DiffOverview_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 571)		int bullShit = 0;
HXLINE( 573)		{
HXLINE( 573)			int _g = 0;
HXDLIN( 573)			int _g1 = this->iconArray->length;
HXDLIN( 573)			while((_g < _g1)){
HXLINE( 573)				_g = (_g + 1);
HXDLIN( 573)				int i = (_g - 1);
HXLINE( 575)				this->iconArray->__get(i).StaticCast<  ::HealthIcon >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 578)		this->iconArray->__get(::FreeplayState_obj::curSelected).StaticCast<  ::HealthIcon >()->set_alpha(( (Float)(1) ));
HXLINE( 580)		{
HXLINE( 580)			int _g2 = 0;
HXDLIN( 580)			::Array< ::Dynamic> _g3 = this->grpSongs->members;
HXDLIN( 580)			while((_g2 < _g3->length)){
HXLINE( 580)				 ::Alphabet item = _g3->__get(_g2).StaticCast<  ::Alphabet >();
HXDLIN( 580)				_g2 = (_g2 + 1);
HXLINE( 582)				item->targetY = ( (Float)((bullShit - ::FreeplayState_obj::curSelected)) );
HXLINE( 583)				bullShit = (bullShit + 1);
HXLINE( 585)				item->set_alpha(((Float)0.6));
HXLINE( 588)				if ((item->targetY == 0)) {
HXLINE( 590)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
