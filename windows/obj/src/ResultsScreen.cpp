...
HXLINE( 200)			::PlayState_obj::rep = null();
HXLINE( 202)			::String songHighscore = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 203)			::String _hx_switch_0 = songHighscore;
            			if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 204)				songHighscore = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 204)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 205)				songHighscore = HX_("Philly",48,eb,f2,23);
HXDLIN( 205)				goto _hx_goto_4;
            			}
            			_hx_goto_4:;
HXLINE( 209)			::Highscore_obj::saveScore(songHighscore,::Math_obj::round(( (Float)(::PlayState_obj::instance->songScore) )),::PlayState_obj::storyDifficulty);
HXLINE( 210)			::String _hx_tmp = ::Ratings_obj::GenerateLetterRank(::PlayState_obj::instance->accuracy);
HXDLIN( 210)			::Highscore_obj::saveCombo(songHighscore,_hx_tmp,::PlayState_obj::storyDifficulty);
HXLINE( 213)			if (::PlayState_obj::isStoryMode) {
HXLINE( 215)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 215)				::String library = null();
HXDLIN( 215)				_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("aliiramenu",99,e8,f4,14)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
HXLINE( 216)				::Conductor_obj::changeBPM(( (Float)(102) ),null());
HXLINE( 217)				{
HXLINE( 217)					 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 220)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 220)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 220)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 221)			::PlayState_obj::instance->clean();
            		}
HXLINE( 224)		bool _hx_tmp1;
HXDLIN( 224)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 224)		if (_this->keyManager->checkStatus(112,_this->status)) {
HXLINE( 224)			_hx_tmp1 = !(::PlayState_obj::loadRep);
            		}
            		else {
HXLINE( 224)			_hx_tmp1 = false;
            		}
HXDLIN( 224)		if (_hx_tmp1) {
HXLINE( 226)			::PlayState_obj::rep = null();
HXLINE( 228)			::PlayState_obj::loadRep = false;
...
HXLINE( 231)			::String _hx_switch_1 = songHighscore;
...
HXLINE( 241)			if (::hx::IsNotNull( this->music )) {
HXLINE( 242)				 ::flixel::_hx_system::FlxSound _this = this->music;
HXDLIN( 242)				 ::Dynamic onComplete = null();
HXDLIN( 242)				if (::hx::IsNotNull( _this->fadeTween )) {
HXLINE( 242)					_this->fadeTween->cancel();
            				}
HXDLIN( 242)				_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(_this->_volume,( (Float)(0) ),((Float)0.3), ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            			}
HXLINE( 244)			::PlayState_obj::isStoryMode = false;
HXLINE( 245)			::PlayState_obj::storyDifficulty = ::PlayState_obj::storyDifficulty;
HXLINE( 246)			{
HXLINE( 246)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN( 246)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 246)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 247)			::PlayState_obj::instance->clean();
            		}
