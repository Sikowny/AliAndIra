...
HXLINE(  31)		::String _hx_switch_0 = daStage;
            		if (  (_hx_switch_0==HX_("backali",57,b1,84,fb)) ){
HXLINE( 400)			this->camZoom = ((Float)0.7);
HXLINE( 404)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-570,-150,null());
HXDLIN( 404)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/backwallBg",ba,0a,c8,b2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 405)			bg1->set_antialiasing(true);
HXLINE( 406)			bg1->setGraphicSize(::Std_obj::_hx_int(bg1->get_width()),null());
HXLINE( 407)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 408)			bg1->set_active(false);
HXLINE( 409)			bg1->updateHitbox();
HXLINE( 410)			this->toAdd->push(bg1);
HXLINE( 415)			 ::flixel::FlxSprite sidewalk =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-530,725,null());
HXDLIN( 415)			 ::flixel::FlxSprite sidewalk1 = sidewalk->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/sidewalkBg",e9,2f,f6,4e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 416)			sidewalk1->set_antialiasing(true);
HXLINE( 417)			sidewalk1->scrollFactor->set(1,1);
HXLINE( 418)			sidewalk1->setGraphicSize(::Std_obj::_hx_int(sidewalk1->get_width()),null());
HXLINE( 419)			sidewalk1->set_active(false);
HXLINE( 420)			sidewalk1->updateHitbox();
HXLINE( 421)			this->toAdd->push(sidewalk1);
HXLINE( 425)			 ::flixel::FlxSprite bgIdiots =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-525,-180,null());
HXLINE( 426)			bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN( 426)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/bgIdiots",c9,82,a9,0e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25));
HXDLIN( 426)			bgIdiots->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/bgIdiots",c9,82,a9,0e)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("weekali",aa,09,02,25))));
HXLINE( 427)			bgIdiots->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BackBoys",ce,ee,cc,dd),24,false,null(),null());
HXLINE( 428)			bgIdiots->setGraphicSize(::Std_obj::_hx_int((bgIdiots->get_width() * ((Float)0.8))),null());
HXLINE( 429)			bgIdiots->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 430)			bgIdiots->set_antialiasing(true);
HXLINE( 431)			bgIdiots->updateHitbox();
HXLINE( 432)			bgIdiots->updateHitbox();
HXLINE( 433)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 435)				this->animatedBacks->push(bgIdiots);
HXLINE( 436)				this->swagBacks->set(HX_("bgIdiots",e5,d7,4d,aa),bgIdiots);
HXLINE( 437)				this->toAdd->push(bgIdiots);
            			}
HXLINE( 442)			 ::flixel::FlxSprite wall =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-550,425,null());
HXDLIN( 442)			 ::flixel::FlxSprite wall1 = wall->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/wallBg",53,d7,8d,65)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 443)			wall1->set_antialiasing(true);
HXLINE( 444)			wall1->scrollFactor->set(1,1);
HXLINE( 445)			int _hx_tmp1 = ::Std_obj::_hx_int(wall1->get_width());
HXDLIN( 445)			wall1->setGraphicSize(_hx_tmp1,::Std_obj::_hx_int((wall1->get_height() * ((Float)0.9))));
HXLINE( 446)			wall1->set_active(false);
HXLINE( 447)			wall1->updateHitbox();
HXLINE( 448)			this->toAdd->push(wall1);
HXLINE( 451)			 ::flixel::FlxSprite dumpster =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,1620,175,null());
HXDLIN( 451)			 ::flixel::FlxSprite dumpster1 = dumpster->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/dumpsterBg",cb,98,b0,0c)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 452)			dumpster1->set_antialiasing(true);
HXLINE( 453)			dumpster1->scrollFactor->set(1,1);
HXLINE( 454)			dumpster1->setGraphicSize(::Std_obj::_hx_int(dumpster1->get_width()),null());
HXLINE( 455)			dumpster1->set_active(false);
HXLINE( 456)			dumpster1->updateHitbox();
HXLINE( 457)			this->toAdd->push(dumpster1);
HXLINE( 460)			 ::flixel::FlxSprite spraycan =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-20,620,null());
HXDLIN( 460)			 ::flixel::FlxSprite spraycan1 = spraycan->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/spraycanBg",4c,41,3d,7a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 461)			spraycan1->set_antialiasing(true);
HXLINE( 462)			spraycan1->scrollFactor->set(1,1);
HXLINE( 463)			spraycan1->setGraphicSize(::Std_obj::_hx_int(spraycan1->get_width()),null());
HXLINE( 464)			spraycan1->set_active(false);
HXLINE( 465)			spraycan1->updateHitbox();
HXLINE( 466)			this->toAdd->push(spraycan1);
HXLINE( 399)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("backaliNight",01,3d,dd,e8)) ){
HXLINE( 494)			this->camZoom = ((Float)0.7);
HXLINE( 498)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-570,-150,null());
HXDLIN( 498)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/backwallBgNight",be,fc,2b,57)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 499)			bg1->set_antialiasing(true);
HXLINE( 500)			bg1->setGraphicSize(::Std_obj::_hx_int(bg1->get_width()),null());
HXLINE( 501)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 502)			bg1->set_active(false);
HXLINE( 503)			bg1->updateHitbox();
HXLINE( 504)			this->toAdd->push(bg1);
HXLINE( 507)			 ::flixel::FlxSprite sidewalk =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-510,725,null());
HXDLIN( 507)			 ::flixel::FlxSprite sidewalk1 = sidewalk->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/sidewalkBgNight",2f,ad,5d,d3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 508)			sidewalk1->set_antialiasing(true);
HXLINE( 509)			sidewalk1->scrollFactor->set(1,1);
HXLINE( 510)			sidewalk1->setGraphicSize(::Std_obj::_hx_int(sidewalk1->get_width()),null());
HXLINE( 511)			sidewalk1->set_active(false);
HXLINE( 512)			sidewalk1->updateHitbox();
HXLINE( 513)			this->toAdd->push(sidewalk1);
HXLINE( 517)			 ::flixel::FlxSprite bgIdiots =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-515,-180,null());
HXLINE( 518)			bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN( 518)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/bgIdiots",c9,82,a9,0e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25));
HXDLIN( 518)			bgIdiots->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/bgIdiots",c9,82,a9,0e)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("weekali",aa,09,02,25))));
HXLINE( 519)			bgIdiots->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BackBoys",ce,ee,cc,dd),24,false,null(),null());
HXLINE( 520)			bgIdiots->setGraphicSize(::Std_obj::_hx_int((bgIdiots->get_width() * ((Float)0.8))),null());
HXLINE( 521)			bgIdiots->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 522)			bgIdiots->set_antialiasing(true);
HXLINE( 523)			bgIdiots->updateHitbox();
HXLINE( 524)			bgIdiots->updateHitbox();
HXLINE( 525)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 527)				this->animatedBacks->push(bgIdiots);
HXLINE( 528)				this->swagBacks->set(HX_("bgIdiots",e5,d7,4d,aa),bgIdiots);
HXLINE( 529)				this->toAdd->push(bgIdiots);
            			}
HXLINE( 534)			 ::flixel::FlxSprite wall =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-550,391,null());
HXDLIN( 534)			 ::flixel::FlxSprite wall1 = wall->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/wallBgNight",85,e5,7c,74)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 535)			wall1->set_antialiasing(true);
HXLINE( 536)			wall1->scrollFactor->set(1,1);
HXLINE( 537)			int _hx_tmp1 = ::Std_obj::_hx_int(wall1->get_width());
HXDLIN( 537)			wall1->setGraphicSize(_hx_tmp1,::Std_obj::_hx_int((wall1->get_height() * ((Float)1.05))));
HXLINE( 538)			wall1->set_active(false);
HXLINE( 539)			wall1->updateHitbox();
HXLINE( 540)			this->toAdd->push(wall1);
HXLINE( 543)			 ::flixel::FlxSprite dumpster =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,1620,175,null());
HXDLIN( 543)			 ::flixel::FlxSprite dumpster1 = dumpster->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/dumpsterBgNight",0d,d1,91,8d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 544)			dumpster1->set_antialiasing(true);
HXLINE( 545)			dumpster1->scrollFactor->set(1,1);
HXLINE( 546)			dumpster1->setGraphicSize(::Std_obj::_hx_int(dumpster1->get_width()),null());
HXLINE( 547)			dumpster1->set_active(false);
HXLINE( 548)			dumpster1->updateHitbox();
HXLINE( 549)			this->toAdd->push(dumpster1);
HXLINE( 552)			 ::flixel::FlxSprite spraycan =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-20,620,null());
HXDLIN( 552)			 ::flixel::FlxSprite spraycan1 = spraycan->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("grafaga/spraycanBg",4c,41,3d,7a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekali",aa,09,02,25)),null(),null(),null(),null(),null());
HXLINE( 553)			spraycan1->set_antialiasing(true);
HXLINE( 554)			spraycan1->scrollFactor->set(1,1);
HXLINE( 555)			spraycan1->setGraphicSize(::Std_obj::_hx_int(spraycan1->get_width()),null());
HXLINE( 556)			spraycan1->set_active(false);
HXLINE( 557)			spraycan1->updateHitbox();
HXLINE( 558)			this->toAdd->push(spraycan1);
HXLINE( 493)			goto _hx_goto_0;
            		}
...
HXLINE( 341)			goto _hx_goto_0;
            		...
            		/* default */{
HXLINE( 563)			this->camZoom = ((Float)0.9);
HXLINE( 564)			this->curStage = HX_("stage",be,6a,0b,84);
HXLINE( 565)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 565)			::String library = null();
HXDLIN( 565)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stageback",e5,7b,3b,06)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 566)			bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 567)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 568)			bg1->set_active(false);
HXLINE( 569)			this->swagBacks->set(HX_("bg",c5,55,00,00),bg1);
HXLINE( 570)			this->toAdd->push(bg1);
HXLINE( 572)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 572)			::String library1 = null();
HXDLIN( 572)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagefront",2b,fd,b0,c6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 573)			stageFront1->setGraphicSize(::Std_obj::_hx_int((stageFront1->get_width() * ((Float)1.1))),null());
HXLINE( 574)			stageFront1->updateHitbox();
HXLINE( 575)			stageFront1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 576)			stageFront1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 577)			stageFront1->set_active(false);
HXLINE( 578)			this->swagBacks->set(HX_("stageFront",0b,6d,de,59),stageFront1);
HXLINE( 579)			this->toAdd->push(stageFront1);
HXLINE( 581)			 ::flixel::FlxSprite stageCurtains =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-300,null());
HXDLIN( 581)			::String library2 = null();
HXDLIN( 581)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagecurtains",df,ec,1a,4b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2),null(),null(),null(),null(),null());
HXLINE( 582)			stageCurtains1->setGraphicSize(::Std_obj::_hx_int((stageCurtains1->get_width() * ((Float)0.9))),null());
HXLINE( 583)			stageCurtains1->updateHitbox();
HXLINE( 584)			stageCurtains1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 585)			stageCurtains1->scrollFactor->set(((Float)1.3),((Float)1.3));
HXLINE( 586)			stageCurtains1->set_active(false);
HXLINE( 588)			this->swagBacks->set(HX_("stageCurtains",ff,a8,cc,24),stageCurtains1);
HXLINE( 589)			this->toAdd->push(stageCurtains1);
            		}
            		_hx_goto_0:;
            	}
