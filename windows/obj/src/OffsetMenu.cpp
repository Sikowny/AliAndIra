...
HX_DEFINE_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_784_new,"OffsetMenu","new",0x7b26d4e4,"OffsetMenu.new","Options.hx",784,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_790_press,"OffsetMenu","press",0xe1888107,"OffsetMenu.press","Options.hx",790,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_806_updateDisplay,"OffsetMenu","updateDisplay",0xd3a7e0bd,"OffsetMenu.updateDisplay","Options.hx",806,0x9d9a0240)

void OffsetMenu_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_784_new)
HXLINE( 785)		super::__construct();
HXLINE( 786)		this->description = desc;
            	}
...
bool OffsetMenu_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_790_press)
HXLINE( 792)		::String poop = ::Highscore_obj::formatSong(HX_("Tutorial",be,4b,67,5c),1);
HXLINE( 794)		::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop,HX_("Tutorial",be,4b,67,5c));
HXLINE( 795)		::PlayState_obj::isStoryMode = false;
HXLINE( 796)		::PlayState_obj::storyDifficulty = 0;
HXLINE( 797)		::PlayState_obj::storyWeek = 0;
HXLINE( 798)		::PlayState_obj::offsetTesting = true;
HXLINE( 800)		{
HXLINE( 800)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN( 800)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 800)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String OffsetMenu_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_806_updateDisplay)
HXDLIN( 806)		return HX_("Time your offset",ed,a5,d2,d4);
            	}
