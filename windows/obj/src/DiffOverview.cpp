...
HXLINE(  61)		::flixel::FlxG_obj::cameras->add(camGame).StaticCast<  ::flixel::FlxCamera >();
HXLINE(  63)		::flixel::FlxG_obj::cameras->add(this->camHUD).StaticCast<  ::flixel::FlxCamera >();
HXLINE(  65)		::flixel::FlxCamera_obj::defaultCameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,camGame);
