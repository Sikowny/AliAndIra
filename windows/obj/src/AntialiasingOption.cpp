...
HX_DEFINE_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_374_new,"AntialiasingOption","new",0x1e0e5b1b,"AntialiasingOption.new","Options.hx",374,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_379_press,"AntialiasingOption","press",0xb20742fe,"AntialiasingOption.press","Options.hx",379,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_70655e35ad0a7bd0_387_updateDisplay,"AntialiasingOption","updateDisplay",0xd93bf1b4,"AntialiasingOption.updateDisplay","Options.hx",387,0x9d9a0240)

void AntialiasingOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_374_new)
HXLINE( 375)		super::__construct();
HXLINE( 376)		this->description = desc;
            	}
...
bool AntialiasingOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_379_press)
HXLINE( 380)		::flixel::FlxG_obj::save->data->__SetField(HX_("antialiasing",f4,16,b3,48),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 381)		this->display = this->updateDisplay();
HXLINE( 382)		return true;
            	}


::String AntialiasingOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_70655e35ad0a7bd0_387_updateDisplay)
HXDLIN( 387)		::String _hx_tmp;
HXDLIN( 387)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ))) {
HXDLIN( 387)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 387)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 387)		return (HX_("Antialiasing ",8c,4e,f1,9b) + _hx_tmp);
            	}
