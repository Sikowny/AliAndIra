...
HX_LOCAL_STACK_FRAME(_hx_pos_93698466c21ed147_6_truncateFloat,"HelperFunctions","truncateFloat",0x44fe3c15,"HelperFunctions.truncateFloat","HelperFunctions.hx",6,0xfb293df1)
HX_LOCAL_STACK_FRAME(_hx_pos_93698466c21ed147_14_GCD,"HelperFunctions","GCD",0xc8d3bca7,"HelperFunctions.GCD","HelperFunctions.hx",14,0xfb293df1)
...
Float HelperFunctions_obj::truncateFloat(Float number,int precision){
            	HX_STACKFRAME(&_hx_pos_93698466c21ed147_6_truncateFloat)
HXLINE(   7)		Float num = number;
HXLINE(   8)		num = (num * ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE(   9)		num = (( (Float)(::Math_obj::round(num)) ) / ::Math_obj::pow(( (Float)(10) ),( (Float)(precision) )));
HXLINE(  10)		return num;
            	}
...
int HelperFunctions_obj::GCD(int a,int b){
            	HX_STACKFRAME(&_hx_pos_93698466c21ed147_14_GCD)
HXDLIN(  14)		if ((b == 0)) {
HXDLIN(  14)			if ((a > 0)) {
HXDLIN(  14)				return a;
            			}
...
HXDLIN(  14)			return ::HelperFunctions_obj::GCD(b,::hx::Mod(a,b));
            		}
HXDLIN(  14)		return 0;
            	}
