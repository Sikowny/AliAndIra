...
HX_DEFINE_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_253_new,"DistractionsAndEffectsOption","new",0x025cdf63,"DistractionsAndEffectsOption.new","Options.hx",253,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_258_press,"DistractionsAndEffectsOption","press",0x2a356946,"DistractionsAndEffectsOption.press","Options.hx",258,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_266_updateDisplay,"DistractionsAndEffectsOption","updateDisplay",0x58e59ffc,"DistractionsAndEffectsOption.updateDisplay","Options.hx",266,0x9d9a0240)

void DistractionsAndEffectsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_253_new)
HXLINE( 254)		super::__construct();
HXLINE( 255)		this->description = desc;
            	}
...
bool DistractionsAndEffectsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_258_press)
HXLINE( 259)		::flixel::FlxG_obj::save->data->__SetField(HX_("distractions",31,13,7d,60),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 260)		this->display = this->updateDisplay();
HXLINE( 261)		return true;
            	}


::String DistractionsAndEffectsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_266_updateDisplay)
HXDLIN( 266)		::String _hx_tmp;
HXDLIN( 266)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) ))) {
HXDLIN( 266)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 266)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 266)		return (HX_("Distractions ",af,07,e4,54) + _hx_tmp);
            	}
