...
HX_DEFINE_STACK_FRAME(_hx_pos_24a6120f5d880dfd_762_new,"WatermarkOption","new",0xd9f8738b,"WatermarkOption.new","Options.hx",762,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_768_press,"WatermarkOption","press",0xcefc576e,"WatermarkOption.press","Options.hx",768,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_777_updateDisplay,"WatermarkOption","updateDisplay",0x9902f624,"WatermarkOption.updateDisplay","Options.hx",777,0x9d9a0240)

void WatermarkOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_762_new)
...
bool WatermarkOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_768_press)
HXLINE( 769)		::Main_obj::watermarks = !(::Main_obj::watermarks);
HXLINE( 770)		::flixel::FlxG_obj::save->data->__SetField(HX_("watermark",a4,af,1e,e0),::Main_obj::watermarks,::hx::paccDynamic);
...
::String WatermarkOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_777_updateDisplay)
HXDLIN( 777)		::String _hx_tmp;
HXDLIN( 777)		if (::Main_obj::watermarks) {
HXDLIN( 777)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 777)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 777)		return (HX_("Watermarks ",d1,dc,17,0d) + _hx_tmp);
            	}
