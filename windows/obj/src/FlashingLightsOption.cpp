...
HX_DEFINE_STACK_FRAME(_hx_pos_59e1436159e1af96_354_new,"FlashingLightsOption","new",0xa84c7996,"FlashingLightsOption.new","Options.hx",354,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_359_press,"FlashingLightsOption","press",0xdee63639,"FlashingLightsOption.press","Options.hx",359,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_367_updateDisplay,"FlashingLightsOption","updateDisplay",0xd86917ef,"FlashingLightsOption.updateDisplay","Options.hx",367,0x9d9a0240)

void FlashingLightsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_354_new)
HXLINE( 355)		super::__construct();
HXLINE( 356)		this->description = desc;
            	}
...
bool FlashingLightsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_359_press)
HXLINE( 360)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 361)		this->display = this->updateDisplay();
HXLINE( 362)		return true;
            	}


::String FlashingLightsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_367_updateDisplay)
HXDLIN( 367)		::String _hx_tmp;
HXDLIN( 367)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) ))) {
HXDLIN( 367)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 367)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 367)		return (HX_("Flashing Lights ",b5,a5,19,88) + _hx_tmp);
            	}
