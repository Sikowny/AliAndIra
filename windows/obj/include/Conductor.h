...
HX_DECLARE_STACK_FRAME(_hx_pos_9bd24c9adde08dff_36_new)
			...
			*(void **)__this = Conductor_obj::_hx_vtable;
{
		...
		static void recalculateTimingStruct( ::Song SONG);
		static ::Dynamic recalculateTimingStruct_dyn();

		static void changeBPM(Float newBpm, ::Dynamic recalcLength);
