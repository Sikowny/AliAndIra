...
HXLINE(  59)		( ( ::Song)(__this) )->stage = HX_("",00,00,00,00);
HXLINE(  58)		( ( ::Song)(__this) )->noteStyle = HX_("",00,00,00,00);
HXLINE(  57)		( ( ::Song)(__this) )->gfVersion = HX_("",00,00,00,00);
HXLINE(  56)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  55)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  53)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  51)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  63)		( ( ::Song)(__this) )->song = song;
HXLINE(  64)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  65)		( ( ::Song)(__this) )->bpm = bpm;
            	}
